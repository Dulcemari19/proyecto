...
<body>
    ...
    readfile('./menu.html');
    ?>
    <a href="guerrerot.php" class="btn btn-light btn-sm float-right"><i class="fa fa-reply"></i> regresar</a>
  ...
  <div class="jumbotron">
    ...
    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
      ...
      <div class="carousel-inner">
        <div class="carousel-item active">
          <img class="d-block w-100" src="img/Terrenos/Guerrero/Terreno 2/1.webp" alt="First slide">
        </div>
    </div>
    ...
    <p>Terreno irregular en renta, total o parcial; ubicado sobre Av.Lopez Mateos, Guerrero.
       -Superficie Total: 9,982.53 m2
       -Frente sobre Av. Emiliano Zapata 114: 55.76 m
       -Frente sobre calle Chapultepec: 123.7 m
       -Fondo: 338.46 m
       -Venta: $ 280.00 pesos por m2.
