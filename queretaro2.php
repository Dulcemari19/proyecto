...
<body>
    ...
    readfile('./menu.html');
    ?>
    <a href="queretarot.php" class="btn btn-light btn-sm float-right"><i class="fa fa-reply"></i> regresar</a>
    ...
    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
      ...
      <div class="carousel-inner">
        <div class="carousel-item active">
          <img class="d-block w-100" src="img/Terrenos/Queretaro/Terreno 2/1.webp"alt="First slide">
        </div>
    </div>
    <h4><strong>Detalles</strong></h4>
                  <div class="w3-row w3-large">
                    <div class="w3-col s6">
                      <p><i class="fa fa-fw fa-compress"></i> Terreno (m²) 8543</p>
                    </div>
                 </div>
    <hr>
    
    <h4><strong>Descripción</strong></h4>
    <p>Terreno irregular en renta, total o parcial; ubicado sobre Av.Queretaro 39, Queretaro.
       -Superficie Total: 8,543.53 m2
       -Frente sobre Av. Monn 214: 64.76 m
       -Frente sobre calle Mariano matamoros: 82.7 m
       -Fondo: 658.46 m
       -Venta: $ 610.00 pesos por m2.
