...
<body>
    ...
    readfile('./menu.html');
    ?>
    <a href="campecheo.php" class="btn btn-light btn-sm float-right"><i class="fa fa-reply"></i> regresar</a>
  ...
  <div class="jumbotron">
    ...
    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
      ...
      <div class="carousel-inner">
        <div class="carousel-item active">
          <img class="d-block w-100" src="img/o1cam.jpg" alt="First slide">
        </div>
    </div>
    ...
    <p>Se renta Oficina. La oficina se encuentra en el 3 nivel con el número 08 y cuenta con 462 m2
