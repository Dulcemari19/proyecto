  ...
  <div class="card-deck mb-3 text-center">
    <div class="card mb-4 shadow-sm">
      ...
      <img src="img/promocion3quintanaroo.jpg"width="300" alt="img_conference" class="rounded float-left mr-4">
        ...
        <a href="quintanaroopromocion1.php"><button type="button" class="btn btn-lg btn-block btn-outline-primary">Observar</button></a>
      </div>
      </div>
      <div class="card mb-4 shadow-sm">
      <div class="card-header">
      ...
      <img src="img/promocion2quintanaroo.jpg"width="300" alt="img_conference" class="rounded float-left mr-4">
        ...
        <a href="quintanaroopromocion2.php"><button type="button" class="btn btn-lg btn-block btn-outline-primary">Observar</button></a>
      </div>
      </div>
      <div class="card mb-4 shadow-sm">
      <div class="card-header">
      ...
      <div class="card-body">
      <img src="img/promociones1quintanaroo.jpg"width="300" alt="img_conference" class="rounded float-left mr-4">
        <ul class="list-unstyled mt-3 mb-4">
          <li>"El compromiso </li>
          <li>es Contigo"</li>
          <li>La mejor calidad aqui en SDI</li>
        </ul>
        <a href="quintanaroopromocion3.php"><button type="button" class="btn btn-lg btn-block btn-outline-primary">Observar</button></a>
      </div>
    </div>
