...
<body>
  ...
  <div class="jumbotron">
    ...
    <center><b><strong><h2 class="w3-text-black">La Terraza</h2></strong></b></center>
    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
      ...
      <div class="carousel-inner">
        <div class="carousel-item active">
          <img class="d-block w-100" src="img/h1sin.jpg" alt="First slide">
        </div>
    </div>
    ...
    <p>Hotel La Terraza renta de departamento por dia, zona de Sinaloa. Departamento con elevador
