...
<body>
  ...
  <div class="jumbotron">
    ...
    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
      ...
      <div class="carousel-inner">
        <div class="carousel-item active">
          <img class="d-block w-100" src="img/Terrenos/Estado de México/Terreno 3/1.jpg" alt="First slide">
        </div>
    </div>t1jal.jpg
    ...
    <p>Terreno irregular en renta, total o parcial; ubicado sobre Av.  Madero,Estado de Mexico.
       -Superficie Total: 9,352.53 m2
       -Frente sobre Av. El Tule 774: 64.76 m
       -Frente sobre calle Pensamiento:662.7 m
       -Fondo: 88.86 m
       -Venta: $ 660.00 pesos por m2.
