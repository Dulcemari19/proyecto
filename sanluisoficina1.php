...
<body>
  ...
  <div class="jumbotron">
    ...
    <center><b><strong><h2 class="w3-text-black">Oficinas Luis</h2></strong></b></center>
    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
      ...
      <div class="carousel-inner">
        <div class="carousel-item active">
          <img class="d-block w-100" src="img/oficina1sanluis.jpg" alt="First slide">
        </div>
    </div>
    ...
    <p>Se renta oficina Luis, se encuentra ubicada en San luis Potosi esta se encuentra en el 1er nivel 
    con el número 4623 y cuenta con 64.94 m2</p>
    <hr>
    <h4><strong>Calcula tu Renta</strong></h4>
    <p>$ 16,800  Mensuales</p>
    <hr>
  <!-- Contact -->
