...
<body>
  ...
  <div class="jumbotron">
    ...
    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
      ...
      <div class="carousel-inner">
        <div class="carousel-item active">
          <img class="d-block w-100" src="img/Terrenos/Puebla/Terreno 3/1.webp" alt="First slide">
        </div>
    </div>
    ...
    <p>Terreno irregular en renta, total o parcial; ubicado sobre Av.El Espacio, Puebla.
       -Superficie Total: 8,662.53 m2
       -Frente sobre Av. Florales 24: 64.76 m
       -Frente sobre calle Manjar: 52.7 m
       -Fondo: 668.46 m
       -Venta: $ 467.00 pesos por m2.
