...
<body>
    ...
    readfile('./menu.html');
    ?>
    <a href="tlaxcalac.php" class="btn btn-light btn-sm float-right"><i class="fa fa-reply"></i> regresar</a>
  ...
  <div class="jumbotron">
    ...
    <center><b><strong><h2 class="w3-text-black">Residencia Tlaxcala</h2></strong></b></center>
    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
      ...
      <div class="carousel-inner">
        <div class="carousel-item active">
          <img class="d-block w-100" src="img/c2tlax.jpg" alt="First slide">
    </div>
    </div>
    ...
    <h4><strong>Detalles</strong></h4>
                  <div class="w3-row w3-large">
                    <div class="w3-col s6">
                      ...
                      <p><i class="fa fa-fw fa-arrows-alt"></i> Terreno (m²) 469</p>
                    </div>
                 </div>
    <hr>
    
    <h4><strong>Descripción</strong></h4>
    <p>Casa en venta Residencia Tlaxcala .Cuenta con 2 niveles, en la planta de abajo cuenta con 1 baño,
    1 cocina,  una sala, 1 comedor y un almacen. En la segunda plata cuenta con 2 recamras y 1 baño.
    ...
    <p>$ 29,970  Condominio en Venta</p>
    <hr>
  <!-- Contact -->
