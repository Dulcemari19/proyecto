...
<body>
  ...
  <div class="jumbotron">
    ...
    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
      ...
      <div class="carousel-inner">
        <div class="carousel-item active">
          <img class="d-block w-100" src="img/h3sin.jpg" alt="First slide">
    </div>
    </div>
    ...
    <p>Hotel La Luna Sinaloa renta de departamento por dia, zona de Sonora. Departamento con elevador
    y cajones de estacionamiento, cuenta con una recamara por habitacion y un baño asi mismo como con 
    , detro del hotel cuentan con alberca, todo para su gran comodidad. </p>
    <hr>
    <h4><strong>Calcula tu Hipoteca</strong></h4>
    <p>$1200  Condominio en Renta</p>
    <hr>
  <!-- Contact -->
