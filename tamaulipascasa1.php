...
<body>
  ...
  <div class="jumbotron">
    ...
    <center><b><strong><h2 class="w3-text-black">Hipoteca Tamaulipas</h2></strong></b></center>
    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
      ...
      <div class="carousel-inner">
        <div class="carousel-item active">
          <img class="d-block w-100" src="img/c1tam.jpg" alt="First slide">
    </div>
    </div>
    ...
    <p>Casa en venta Hipoteca Tamaulipas .Cuenta con 2 niveles, en la plana de arriba cuenta con 2 recamaras 
    y 1 baño, en la planta de abajo cuenta con 1 cocina, una sala,1 baño, 1 comedor y un almacen. 
    Por la parte de afuera cuenta con un estacionamiento, y un pequeño Jardin todo para su gran comodidad.</p>
    <hr>
    <h4><strong>Calcula tu Hipoteca</strong></h4>
    <p>$ 29,380  Condominio en Venta</p>
    <hr>
  <!-- Contact -->
