...
<body>
  ...
  <div class="jumbotron">
    ...
    <center><b><strong><h2 class="w3-text-black">Imperial House</h2></strong></b></center>
    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
      ...
      <div class="carousel-inner">
        <div class="carousel-item active">
          <img class="d-block w-100" src="img/c1zac.jpg" alt="First slide">
    </div>
    </div>
    ...
    <h4><strong>Detalles</strong></h4>
                  <div class="w3-row w3-large">
                    <div class="w3-col s6">
                      ...
                      <p><i class="fa fa-fw fa-compress"></i> Construidos (m²) 664 </p>
    ...
    <p>Casa en venta Imperial House. Cuenta con 2 niveles, en la planta de abajo cuenta concuenta  con 2 recamaras,
     1 baño, cuenta con 1 cocina, una sala, 1 comedor y un almacen, en la segunda planta que es la de arriba
     cuenta con 2 recamaras y un baño. Por la parte de afuera cuenta con un estacionamiento, y un pequeño
    Patio todo para su gran comodidad.</p>
    <hr>
    <h4><strong>Calcula tu Hipoteca</strong></h4>
    <p>$ 50,490  Condominio en Venta</p>
    <hr>
  <!-- Contact -->
