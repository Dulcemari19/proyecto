...
<body>
    ...
    readfile('./menu.html');
    ?>
    <a href="aguascalientest.php" class="btn btn-light btn-sm float-right"><i class="fa fa-reply"></i> regresar</a>
  ...
  <div class="jumbotron">
    ...
    <center><b><strong><h2 class="w3-text-black">Convención 1914 y Montebello</h2></strong></b></center>
    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
      ...
      <div class="carousel-inner">
        <div class="carousel-item active">
          <img class="d-block w-100" src="img/terreno1.jpg" alt="First slide">
        </div>
    </div>
    <h4><strong>Detalles</strong></h4>
                  <div class="w3-row w3-large">
                    <div class="w3-col s6">
                      <p><i class="fa fa-fw fa-compress"></i> Terreno (m²) 8442</p>
                    </div>
                 </div>
    <hr>
    
    <h4><strong>Descripción</strong></h4>
    <p>Terreno irregular en renta, total o parcial; ubicado sobre Av. De la Convención 1914 Poniente y calle Montebello, Col. Panorama, Aguascalientes, Ags.
       -Superficie Total: 8,442.53 m2
       -Frente sobre Av. de la Convención 1914: 54.96 m
       -Frente sobre calle Montebello: 72.4 m
       -Fondo: 127.46 m
       -Venta: $ 35.00 pesos por m2.
