...
<body>
  ...
  <div class="jumbotron">
    ...
    <p>Departamento en renta en Terranza, zona Campestre, Aguascalientes, Ags., 
    cuenta con 2 recámaras, 2 baños, sala comedor, cocina integral equipada, cuarto de servicio, 
    dos cajones de estacionamiento, incluye cuota de mantenimiento</p>
    <hr>
    <h4><strong>Calcula tu Renta</strong></h4>
    <p>$ 13,500  Mensuales</p>
    <hr>
  <!-- Contact -->
