...
<body>
  ...
  <div class="jumbotron">
    ...
    <center><b><strong><h2 class="w3-text-black">Casa Blanca</h2></strong></b></center>
    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
      ...
      <div class="carousel-inner">
        <div class="carousel-item active">
          <img class="d-block w-100" src="img/c3tlax.jpg" alt="First slide">
    </div>
    </div>
    ...
    <p>Casa en venta Casa Blanca .Cuenta con 2 niveles, en la planta de abajo cuenta con 1 baño,
    ...
    <p>$ 21,110  Condominio en Venta</p>
    <hr>
  <!-- Contact -->
