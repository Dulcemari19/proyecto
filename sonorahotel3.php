...
<body>
  ...
  <div class="jumbotron">
    ...
    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
      ...
      <div class="carousel-inner">
        <div class="carousel-item active">
          <img class="d-block w-100" src="img/h3son.jpg" alt="First slide">
        </div>
    </div>
    ...
    <p>Hotel Messe renta de departamento por dia, zona de Sonora. Departamento con elevador de 6 pisos 
    y cajones de estacionamiento, cuenta con una recamara por habitacion y un baño, detro del hotel cuentan 
    con alberca camillas de descanzo y todo para su gran comodidad.</p>
    <hr>
