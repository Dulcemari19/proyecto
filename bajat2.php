    ...
    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
      ...
      <div class="carousel-inner">
        <div class="carousel-item active">
          <img class="d-block w-100" src="img/Terrenos/Baja california/Terreno 2/01.webp" alt="First slide">
        </div>
    </div>
    <h4><strong>Detalles</strong></h4>
                  <div class="w3-row w3-large">
                    <div class="w3-col s6">
                      <p><i class="fa fa-fw fa-compress"></i> Terreno (m²) 12532</p>
                    </div>
                 </div>
    <hr>
    
    <h4><strong>Descripción</strong></h4>
    <p>Terreno irregular en renta, total o parcial; ubicado sobre Av.El Paso 63, Baja California.
       -Superficie Total: 12,532.53 m2
       -Frente sobre Av. Aldama 1194: 64.76 m
       -Frente sobre calle Calzada: 82.7 m
       -Fondo: 759.46 m
       -Venta: $ 200.00 pesos por m2.
