...
<body>
  ...
  <div class="jumbotron">
    ...
    <center><b><strong><h2 class="w3-text-black">Aedas</h2></strong></b></center>
    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
      ...
      <div class="carousel-inner">
        <div class="carousel-item active">
          <img class="d-block w-100" src="img/o2son.jpg" alt="First slide">
        </div>
    </div>
    ...
    <p>Se renta Aedas. La oficina se encuentra en el 3er nivel con el número 243 y cuenta con 200 m2
