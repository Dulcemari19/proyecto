     ...
     <h1>SDI House</h1>
      ...
      <div class="container">
        ...
        <div class="row">
            <div class="col-sm-4">
              <h3></h3>
             <img src="img/casa1.jpg"width="200" alt="img_conference" class="rounded float-left mr-4">
            </div>
            <div class="col-sm-4">
              ...
              <div class="col-sm-4">
                  ...
                  <div class="row">
                    <div class="col-sm-4">
                     <img id="casa2" src="img/casa2.jpg"width="200" alt="img_conference" class="rounded float-left mr-4">
                    </div>
                    <div class="col-sm-4">
                      <h4><strong>Servicios</strong></h4>
                      <div class="w3-row w3-large">
