...
<body>
    ...
    readfile('./menu.html');
    ?>
    <a href="yucatanp.php" class="btn btn-light btn-sm float-right"><i class="fa fa-reply"></i> regresar</a>
  ...
  <div class="jumbotron">
    ...
    <center><b><strong><h2 class="w3-text-black">El Jiadi</h2></strong></b></center>
    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
      ...
      <div class="carousel-inner">
        <div class="carousel-item active">
          <img class="d-block w-100" src="img/p2yuc.jpg" alt="First slide">
        </div>
    </div>
    ...
    <p>Hotel El Jiadi renta de departamento por dia, zona de Yucatan. Departamento con elevador
    y cajones de estacionamiento, cuenta con una recamara por habitacion y un baño, asi como 
    un ropero, una television, detro del hotel cuentan con camillas de descanzo y un gran patio 
