...
<body>
    ...
    readfile('./menu.html');
    ?>
    <a href="quintanarooh.php" class="btn btn-light btn-sm float-right"><i class="fa fa-reply"></i> regresar</a>
  ...
  <div class="jumbotron">
    ...
    <center><b><strong><h2 class="w3-text-black">Cabañas Rivera Maya.</h2></strong></b></center>
    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
      ...
      <div class="carousel-inner">
        <div class="carousel-item active">
          <img class="d-block w-100" src="img/hotel3quintanaroo.jpg" alt="First slide">
    </div>
    </div>
    ...
    <h4><strong>Detalles</strong></h4>
                  <div class="w3-row w3-large">
                    <div class="w3-col s6">
                      <p><i class="fa fa-fw fa-bed"></i> 1 Cabaña con 1 recamara</p>
                      <p><i class="fa fa-fw fa-door-open"></i> 2 Habitaciones(en total)</p>
                      <p><i class="fa fa-fw fa-toilet"></i> 1 baños</p>
                      <p><i class="fa fa-fw fa-water"></i> Dentro del mar</p>
                      <p><i class="fa fa-fw fa-bed"></i> 1 Cama</p>
                      <p><i class="fa fa-fw fa-user-cog"></i> Construido (año) 2000</p>
                      <p><i class="fa fa-fw fa-compress"></i> Construidos (m²) 110 </p>
                      <p><i class="fa fa-fw fa-arrows-alt"></i> Terreno (m²) 100</p>
                    </div>
                 </div>
    <hr>
    
    <h4><strong>Descripción</strong></h4>
    <p>Cabañas Rivera Maya, son cabañas ubicadas en Quintana Roo, estas se encuentan sobre el agua 
    de la Rivera Maya son de exelente comodidad, cuentan con renta por dia es una cabaña con una recamara,
    1 baño,1 cama, dentro tambien cuenta con una cocina pequeña y una sala. </p>
    <hr>
    <h4><strong>Calcula tu Hipoteca</strong></h4>
    <p>$4000 Condominio en Renta</p>
    <hr>
  <!-- Contact -->
