...
<body>
  ...
  <div class="jumbotron">
    ...
    <center><b><strong><h2 class="w3-text-black">Residencia Veracruz</h2></strong></b></center>
    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
      ...
      <div class="carousel-inner">
        <div class="carousel-item active">
          <img class="d-block w-100" src="img/c2ver.jpg" alt="First slide">
    </div>
    </div>
    ...
    <p>Casa en venta Residencia Veracruz. Cuenta con 2 niveles, en la planta de abajo cuenta concuenta  con
    1 recamara, 1 baño, cuenta con 1 cocina, una sala, 1 comedor y un almacen, en la segunda planta  cuenta 
    con 2 recamaras y un baño. Por la parte de afuera cuenta con un estacionamiento, y un pequeño Patio todo 
    para su gran comodidad.</p>
    <hr>
    <h4><strong>Calcula tu Hipoteca</strong></h4>
    <p>$ 35,460  Condominio en Venta</p>
    <hr>
  <!-- Contact -->
