...
<body>
    ...
    readfile('./menu.html');
    ?>
    <a href="veracruzc.php" class="btn btn-light btn-sm float-right"><i class="fa fa-reply"></i> regresar</a>
  ...
  <div class="jumbotron">
    ...
    <center><b><strong><h2 class="w3-text-black">La Cruz</h2></strong></b></center>
    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
      ...
      <div class="carousel-inner">
        <div class="carousel-item active">
          <img class="d-block w-100" src="img/c3ver.jpg" alt="First slide">
    </div>
    </div>
    ...
    <p>Casa en venta El Pilar .Cuenta con 2 niveles, en la planta de abajo cuenta concuenta  con 2 recamaras,
     1 baño, cuenta con 1 cocina, una sala, 1 comedor y un almacen, en la segunda planta ques es la de arriba
     cuenta con 2 recamaras y un baño. Por la parte de afuera cuenta con 2 estacionamientos. 
     Todo para su gran comodidad.</p>
    <hr>
    <h4><strong>Calcula tu Hipoteca</strong></h4>
    <p>$ 45,490  Condominio en Venta</p>
    <hr>
 <!-- Contact -->
