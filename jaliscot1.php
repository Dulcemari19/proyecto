...
<body>
  ...
  <div class="jumbotron">
    ...
    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
      ...
      <div class="carousel-inner">
        <div class="carousel-item active">
          <img class="d-block w-100" src="img/Terrenos/Jalisco/Terreno 1/1.webp" alt="First slide">
        </div>
    </div>t1jal.jpg
    ...
    <p>Terreno irregular en renta, total o parcial; ubicado sobre Av.super manzana 309, Jalisco.
