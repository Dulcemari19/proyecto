...
<body>
  ...
  <div class="jumbotron">
    ...
    <center><b><strong><h2 class="w3-text-black">Residencial Potosi</h2></strong></b></center>
    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
      ...
      <div class="carousel-inner">
        <div class="carousel-item active">
          <img class="d-block w-100" src="img/c2sl.jpg" alt="First slide">
    </div>
    </div>
    ...
    <h4><strong>Detalles</strong></h4>
                  <div class="w3-row w3-large">
                    <div class="w3-col s6">
                      ...
                      <p><i class="fa fa-fw fa-compress"></i> Construidos (m²) 520 </p>
    ...
    <p>Casa en venta en San Luis Potosi, cuenta con 2 niveles. En la planta de abjo cuenta con 2 recamaras, 1 sala,
    1 cocina, 2 baños, en la planta de arriba cuenta con 2 recamaras y 2 baños, por la parte de afuera cuenta con 
    un estacionamiento y un almacen. Todo para tu gran comodidad. </p>
    <hr>
    <h4><strong>Calcula tu Hipoteca</strong></h4>
    <p>$ 10,980,000  Condominio en Venta</p>
    <hr>
  <!-- Contact -->
