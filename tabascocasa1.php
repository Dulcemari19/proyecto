...
<body>
  ...
  <div class="jumbotron">
    ...
    <center><b><strong><h2 class="w3-text-black">Propieda San Marcos</h2></strong></b></center>
    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
      ...
      <div class="carousel-inner">
        <div class="carousel-item active">
          <img class="d-block w-100" src="img/c1tab.jpg" alt="First slide">
    </div>
    </div>
    ...
    <h4><strong>Detalles</strong></h4>
                  <div class="w3-row w3-large">
                    <div class="w3-col s6">
                      ...
                      <p><i class="fa fa-fw fa-compress"></i> Construidos (m²) 234 </p>
    ...
    <p>Casa en venta Propieda San Marcos.Cuenta con 1 nivel, Cuenta con 2 recamaras  y 1 baño, cuenta
    con 1 cocina, una sala, 1 comedor y un almacen. 
    ...
    <p>$ 27,980  Condominio en Venta</p>
    <hr>
  <!-- Contact -->
