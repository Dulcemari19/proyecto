...
<body>
  ...
  <div class="jumbotron">
    ...
    <center><b><strong><h2 class="w3-text-black">El Potrerito</h2></strong></b></center>
    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
      ...
      <div class="carousel-inner">
        <div class="carousel-item active">
          <img class="d-block w-100" src="img/t3zac.jpg" alt="First slide">
        </div>
    </div>
    <h4><strong>Detalles</strong></h4>
                  <div class="w3-row w3-large">
                    <div class="w3-col s6">
                      <p><i class="fa fa-fw fa-compress"></i> Terreno (m²) 9982</p>
                    </div>
                 </div>
    <hr>
    ...
    <p>Terreno irregular en renta, total o parcial; ubicado sobre Av. San Diego 92, Zacatecas.
       -Superficie Total: 9,992.53 m2
       -Frente sobre Av. Villa 206: 83.79 m
       -Frente sobre calle El Puente: 53.4 m
       -Fondo: 606.47 m
