...
<body>
  ...
  <div class="jumbotron">
    ...
    <center><b><strong><h2 class="w3-text-black">San Carlos</h2></strong></b></center>
    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
      ...
      <div class="carousel-inner">
        <div class="carousel-item active">
          <img class="d-block w-100" src="img/o3sin.jpg" alt="First slide">
        </div>
    </div>
    ...
    <h4><strong>Detalles</strong></h4>
                  <div class="w3-row w3-large">
                    <div class="w3-col s6">
                      ...
                      <p><i class="fa fa-fw fa-compress"></i> Construidos (m²) 88</p>
    ...
    <p>Se renta Oficina El Dueño. La oficina se encuentra en el 2 nivel con el número 219 y cuenta con 88 m2
    cuenta con escritorio y sillas suficientes, asi como una  sala pequeña y pequeñas decoraciones, todo para su gran comodidad.</p>
    <hr>
    <h4><strong>Calcula tu Renta</strong></h4>
    <p>$ 19,500  Mensuales</p>
    <hr>
  <!-- Contact -->
