...
<body>
  ...
  <div class="jumbotron">
    ...
    <p>Casa en venta en San Luis Potosi, cuenta con 3  niveles. En la parte de abjo cuenta con 1 sala, 1 baño,
    1 comedor, en el segundo nivel cuenta con 2 recamaras y 2 baños y en la 3° planta cuenta con 2 recamaras mas
    y 1 baño, por la parte de afuera cue nta con un pequeño jardin y estacionamiento. Todo para tu gran comodidad. </p>
    <hr>
    <h4><strong>Calcula tu Hipoteca</strong></h4>
    <p>$ 9,980,000  Condominio en Venta</p>
    <hr>
  <!-- Contact -->
