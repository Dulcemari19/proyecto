...
<body>
  ...
  <div class="jumbotron">
    ...
    <center><b><strong><h2 class="w3-text-black">Mi Propiedad</h2></strong></b></center>
    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
      ...
      <div class="carousel-inner">
        <div class="carousel-item active">
          <img class="d-block w-100" src="img/c1son.jpeg" alt="First slide">
    </div>
    </div>
    ...
    <p>Casa en venta Mi Propiedad.Cuenta con 2 niveles, en la parte de abajo cuenta con 2 recamaras  y 1 baño cada una,
    ...
    <p>$ 18,980,0  Condominio en Venta</p>
    <hr>
  <!-- Contact -->
