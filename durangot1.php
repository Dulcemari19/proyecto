...
<body>
    ...
    readfile('./menu.html');
    ?>
    <a href="durangot.php" class="btn btn-light btn-sm float-right"><i class="fa fa-reply"></i> regresar</a>
  ...
  <div class="jumbotron">
    ...
    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
      ...
      <div class="carousel-inner">
        <div class="carousel-item active">
          <img class="d-block w-100" src="img/Terrenos/Durango/Terreno 1/1.webp" alt="First slide">
        </div>
    </div>
    ...
    <p>Terreno irregular en renta, total o parcial; ubicado sobre Av. Alameda Central, Durango.
       -Superficie Total: 9,386.53 m2
       -Frente sobre Av. Autopan 14: 32.76 m
       -Frente sobre calle Reforma: 386.7 m
       -Fondo: 128.26 m
       -Venta: $ 190.00 pesos por m2.
