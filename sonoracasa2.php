...
<body>
    ...
    readfile('./menu.html');
    ?>
    <a href="sonorac.php" class="btn btn-light btn-sm float-right"><i class="fa fa-reply"></i> regresar</a>
  ...
  <div class="jumbotron">
    ...
    <center><b><strong><h2 class="w3-text-black">Residencia Sonora</h2></strong></b></center>
    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
      ...
      <div class="carousel-inner">
        <div class="carousel-item active">
          <img class="d-block w-100" src="img/c2son.jpg" alt="First slide">
    </div>
    </div>
    ...
    <h4><strong>Detalles</strong></h4>
                  <div class="w3-row w3-large">
                    <div class="w3-col s6">
                      ...
                      <p><i class="fa fa-fw fa-compress"></i> Construidos (m²) 551 </p>
                      <p><i class="fa fa-fw fa-arrows-alt"></i> Terreno (m²) 439</p>
                    </div>
                 </div>
    <hr>
    
    <h4><strong>Descripción</strong></h4>
    <p>Casa en venta Residencia Sonora .Cuenta con 2 niveles, en la parte de abajo cuenta con 2 recamaras  y 1 baño cada una,
    cuenta con 1 cocina, una sala, 1 comedor y un almacen. En la segunda planta se encuentran 2 recamaras con baño completo,
    por la parte de afuera cuenta con un estacionamiento, un jardin y una alberca todo para su gran comodidad.</p>
    <hr>
    <h4><strong>Calcula tu Hipoteca</strong></h4>
    <p>$ 55,980,0  Condominio en Venta</p>
    <hr>
  <!-- Contact -->
