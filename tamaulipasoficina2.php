...
<body>
    ...
    readfile('./menu.html');
    ?>
    <a href="tamaulipaso.php" class="btn btn-light btn-sm float-right"><i class="fa fa-reply"></i> regresar</a>
  ...
  <div class="jumbotron">
    ...
    <center><b><strong><h2 class="w3-text-black">Oficinas Tamaulipas</h2></strong></b></center>
    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
      ...
      <div class="carousel-inner">
        <div class="carousel-item active">
          <img class="d-block w-100" src="img/o2tam.jpg" alt="First slide">
        </div>
    </div>
    ...
    <h4><strong>Detalles</strong></h4>
                  <div class="w3-row w3-large">
                    <div class="w3-col s6">
                      ...
                      <p><i class="fa fa-fw fa-compress"></i> Construidos (m²) 422</p>
    ...
    <p>Se renta Oficinas Tamaulipas. La oficina se encuentra en el 2 nivel con el número 172 y cuenta con 422 m2
    cuenta con escritorios y sillas suficientes, asi como una  sala pequeña y pequeñas decoraciones, todo 
