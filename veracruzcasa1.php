...
<body>
  ...
  <div class="jumbotron">
    ...
    <center><b><strong><h2 class="w3-text-black">El Pilar</h2></strong></b></center>
    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
      ...
      <div class="carousel-inner">
        <div class="carousel-item active">
          <img class="d-block w-100" src="img/c1ver.jpg" alt="First slide">
    </div>
    </div>
    ...
    <p>Casa en venta El Pilar .Cuenta con 2 niveles, en la planta de abajo cuenta concuenta  con 1 recamara,
