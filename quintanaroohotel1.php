...
<body>
  ...
  <div class="jumbotron">
    ...
    <center><b><strong><h2 class="w3-text-black">Hotel La Unión</h2></strong></b></center>
    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
      ...
      <div class="carousel-inner">
        <div class="carousel-item active">
          <img class="d-block w-100" src="img/hotel1quiontanaroo.jpg" alt="First slide">
    </div>
    </div>
    ...
    <p>Hotel La Union renta de departamento por dia, zona de Quintana Roo. Departamento con elevador
    y cajones de estacionamiento, cuenta con una recamara por habitacion y un baño asi mismo como con 
    , detro del hotel cuentan con alberca camillas de descanzo y todo para su gran comodidad. </p>
    <hr>
    <h4><strong>Calcula tu Hipoteca</strong></h4>
    <p>$1500  Condominio en Renta</p>
    <hr>
   <!-- Contact -->
