...
<body>
  ...
  <div class="jumbotron">
    ...
    <center><b><strong><h2 class="w3-text-black">Hotel Zone</h2></strong></b></center>
    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
      ...
      <div class="carousel-inner">
        <div class="carousel-item active">
          <img class="d-block w-100" src="img/hotel2quintanaroo.jpg" alt="First slide">
    </div>
    </div>
    ...
    <p>Hotel Zone renta de departamento por dia, zona de Quintana Roo. Departamento con elevador
