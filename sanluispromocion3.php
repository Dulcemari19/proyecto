...
<body>
  ...
  <div class="jumbotron">
    ...
    <center><b><strong><h2 class="w3-text-black">Residencia la Loma</h2></strong></b></center>
    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
      ...
      <div class="carousel-inner">
        <div class="carousel-item active">
          <img class="d-block w-100" src="img/p3tsl.jpg" alt="First slide">
        </div>
    </div>
    ...
    <p>Terreno irregular en renta, total o parcial; ubicado sobre Av.San Carlos, sobre calle Chapultepec, San Luis Potosi.
       -Superficie Total: 7,442.23 m2
       -Frente sobre Av.San Carlos : 52.96 m
       -Frente sobre calle Chapultepec: 93.4 m
       -Fondo: 150.48 m
       -Venta: $ 120.00 pesos por m2.
