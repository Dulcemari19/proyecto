...
<body>
  ...
  <div class="jumbotron">
    ...
    <center><b><strong><h2 class="w3-text-black">Camino Real</h2></strong></b></center>
    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
      ...
      <div class="carousel-inner">
        <div class="carousel-item active">
          <img class="d-block w-100" src="img/t1zac.jpg" alt="First slide">
        </div>
    </div>
    <h4><strong>Detalles</strong></h4>
                  <div class="w3-row w3-large">
                    <div class="w3-col s6">
                      <p><i class="fa fa-fw fa-compress"></i> Terreno (m²) 14542</p>
                    </div>
                 </div>
    <hr>
    ...
    <p>Terreno irregular en renta, total o parcial; ubicado sobre Av. San Diego 92, Zacatecas.
       -Superficie Total: 14,542.53 m2
       -Frente sobre Av. Villa 2009: 83.79 m
       -Frente sobre calle El Dorado: 63.4 m
       -Fondo: 996.47 m
       -Venta: $ 1330.00 pesos por m2.
