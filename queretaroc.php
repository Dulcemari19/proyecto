  ...
  <div class="card-deck mb-3 text-center">
    <div class="card mb-4 shadow-sm">
      ...
      <img src="img/Queretaro/casa 1/1.webp"width="300" alt="img_conference" class="rounded float-left mr-4">
        ...
        <a href="queretaroc1.php"><button type="button" class="btn btn-lg btn-block btn-outline-primary">Observar</button></a>
      </div>
      </div>
      <div class="card mb-4 shadow-sm">
      <div class="card-header">
      ...
      <img src="img/Queretaro/casa 2/1.webp"width="300" alt="img_conference" class="rounded float-left mr-4">
        ...
        <a href="queretaroc2.php"><button type="button" class="btn btn-lg btn-block btn-outline-primary">Observar</button></a>
      </div>
      </div>
      <div class="card mb-4 shadow-sm">
      <div class="card-header">
      ...
      <ul class="list-unstyled mt-3 mb-4">
        ...
        <a href="queretaroc3.php"><button type="button" class="btn btn-lg btn-block btn-outline-primary">Observar</button></a>
      </div>
    </div>