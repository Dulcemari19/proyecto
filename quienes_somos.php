        ...
        <div class="card">
            <div class="card-header">
                ...
                <h3>SDI es empresa encargada de la venta y renta de bienes raices , la cual se encuentra a su disposicion para que usted pueda adquirir alguno de nuestros distintos tipos de inmuebles que se le busca ofrecer.
                    ...
                    Somos una empresa comprometida , que tiene valores y sobre todo responsabilidad , busacamos satisfacer todas susnecesidades ya que usted nos a puesto toda su confianza en nosotros , es por ello que nosotros nos 
                    encargaremos de culpmir con todas y cada una de las especificaciones que usted nos otorge.  </h3>
    </form>
</div>
</div>
</div>
