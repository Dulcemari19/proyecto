...
<body>
  ...
  <div class="jumbotron">
    ...
    <center><b><strong><h2 class="w3-text-black">Oficina Benito Juarez</h2></strong></b></center>
    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
      ...
      <div class="carousel-inner">
        <div class="carousel-item active">
          <img class="d-block w-100" src="img/oficina1quintanaroo.jpg" alt="First slide">
        </div>
    </div>
    ...
    <p>Se renta oficina en Hotelera Benito juarez. La oficina se encuentra en el 3er nivel con el número 2472 y cuenta con 75 m2</p>
    <hr>
