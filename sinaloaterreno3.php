...
<body>
    ...
    readfile('./menu.html');
    ?>
    <a href="sinaloat.php" class="btn btn-light btn-sm float-right"><i class="fa fa-reply"></i> regresar</a>
  ...
  <div class="jumbotron">
    ...
    <center><b><strong><h2 class="w3-text-black">La Primavera</h2></strong></b></center>
    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
      ...
      <div class="carousel-inner">
        <div class="carousel-item active">
          <img class="d-block w-100" src="img/t3sin.jpg" alt="First slide">
        </div>
    </div>
    <h4><strong>Detalles</strong></h4>
                  <div class="w3-row w3-large">
                    <div class="w3-col s6">
                      <p><i class="fa fa-fw fa-compress"></i> Terreno (m²) 8706</p>
                    </div>
                 </div>
    <hr>
    
    <h4><strong>Descripción</strong></h4>
    <p>Terreno irregular en renta, total o parcial; ubicado sobre Av. La Cruz 189, Sinaloa.
       -Superficie Total: 8,706.53 m2
       -Frente Av. Hidalgo 795: 53.79 m
       -Frente sobre calle Chapultepec II: 99.6 m
       -Fondo: 671.47 m
