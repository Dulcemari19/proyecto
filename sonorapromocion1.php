...
<body>
    ...
    readfile('./menu.html');
    ?>
    <a href="sonorap.php" class="btn btn-light btn-sm float-right"><i class="fa fa-reply"></i> regresar</a>
  ...
  <div class="jumbotron">
    ...
    <center><b><strong><h2 class="w3-text-black">Santa Lucia</h2></strong></b></center>
    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
      ...
      <div class="carousel-inner">
        <div class="carousel-item active">
          <img class="d-block w-100" src="img/p1son.png" alt="First slide">
    </div>
    </div>
    ...
    <p>Casa en venta Santa Lucia.Cuenta con 1 nivel,cuenta con 1 recamara y 1 baño,cuenta con 1 cocina,
    una sala, 1 comedor.Por la parte de afuera cuenta con un estacionamiento y un jardin pequeño.
    Todo para su gran comodidad.</p>
    <hr>
    <h4><strong>Calcula tu Hipoteca</strong></h4>
    <p>$ 16,980,0  Condominio en Venta</p>
    <hr>
 <!-- Contact -->
