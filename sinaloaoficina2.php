...
<body>
  ...
  <div class="jumbotron">
    ...
    <center><b><strong><h2 class="w3-text-black">El Dueño</h2></strong></b></center>
    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
      ...
      <div class="carousel-inner">
        <div class="carousel-item active">
          <img class="d-block w-100" src="img/o2sin.jpg" alt="First slide">
        </div>
    </div>
    ...
    <p>Se renta Oficina El Dueño. La oficina se encuentra en el 2 nivel con el número 117 y cuenta con 100 m2
    cuenta con escritorio y sillas suficientes, asi como una  sala pequeña y pequeñas decoraciones, todopara su gran comodidad.</p>
    <hr>
    <h4><strong>Calcula tu Renta</strong></h4>
    <p>$ 14,700  Mensuales</p>
    <hr>
 <!-- Contact -->
