...
<body>
  ...
  <div class="jumbotron">
    ...
    <center><b><strong><h2 class="w3-text-black">Oficinas Playa del Carmen</h2></strong></b></center>
    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
      ...
      <div class="carousel-inner">
        <div class="carousel-item active">
          <img class="d-block w-100" src="img/oficinaquintana2.jpg" alt="First slide">
        </div>
    </div>
      <h4><strong>Servicios</strong></h4>
              <div class="w3-row w3-large">
                <div class="w3-col s6">
                  ...
                  <p><i class="fa fa-fw fa-water"></i> Jardin</p>
                </div>
              </div>
    <hr>
    <h4><strong>Detalles</strong></h4>
                  <div class="w3-row w3-large">
                    <div class="w3-col s6">
                      ...
                      <p><i class="fa fa-fw fa-compress"></i> Construidos (m²) 80 </p>
    ...
    <p>Se renta oficina en Playa del Carmen, Quintana Roo. La oficina se encuentra en el 1er nivel con el número 2975 y cuenta con 75 m2
    dentro de ella tambien cuenta con las sillas y escritorios un baño</p>
    <hr>
    <h4><strong>Calcula tu Renta</strong></h4>
    <p>$ 20,800  Mensuales</p>
    <hr>
 <!-- Contact -->
