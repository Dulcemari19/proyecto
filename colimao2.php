...
<body>
  ...
  <div class="jumbotron">
    ...
    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
      ...
      <div class="carousel-inner">
        <div class="carousel-item active">
          <img class="d-block w-100" src="img/o2col.jpg" alt="First slide">
        </div>
    </div>
    ...
    <p>Se renta Oficina. La oficina se encuentra en el 3 nivel con el número 87 y cuenta con 498 m2
