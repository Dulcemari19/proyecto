...
<body>
  ...
  <div class="jumbotron">
    ...
    <center><b><strong><h2 class="w3-text-black">El Valle</h2></strong></b></center>
    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
      ...
      <div class="carousel-inner">
        <div class="carousel-item active">
          <img class="d-block w-100" src="img/c3yuc.jpg" alt="First slide">
    </div>
    </div>
    ...
    <h4><strong>Detalles</strong></h4>
                  <div class="w3-row w3-large">
                    <div class="w3-col s6">
                      ...
                      <p><i class="fa fa-fw fa-compress"></i> Construidos (m²) 332 </p>
                      <p><i class="fa fa-fw fa-arrows-alt"></i> Terreno (m²) 499</p>
                    </div>
                 </div>
    <hr>
    
    <h4><strong>Descripción</strong></h4>
    <p>Casa en venta El Valle.Cuenta con 1 nivel, cuenta con 2 recamaras, 1 baño, 1 cocina, una sala, 
    1 comedor y un almacen.Por la parte de afuera cuenta con un estacionamiento, y un pequeño Jardin. 
    Todo para su gran comodidad.</p>
    <hr>
    <h4><strong>Calcula tu Hipoteca</strong></h4>
    <p>$ 31,430  Condominio en Venta</p>
    <hr>
  <!-- Contact -->
