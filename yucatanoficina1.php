...
<body>
  ...
  <div class="jumbotron">
    ...
    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
      ...
      <div class="carousel-inner">
        <div class="carousel-item active">
          <img class="d-block w-100" src="img/o1yuc.jpg" alt="First slide">
        </div>
    </div>
    ...
    <p>Se renta Oficina Las Ventanas. La oficina se encuentra en el 3 nivel con el número 122 y cuenta con 522 m2
    cuenta con 1 escritorio y sillas suficientes, asi como una  sala pequeña, un baño y 
