...
<body>
    ...
    readfile('./menu.html');
    ?>
    <a href="sanluisc.php" class="btn btn-light btn-sm float-right"><i class="fa fa-reply"></i> regresar</a>
  ...
  <div class="jumbotron">
    ...
    <center><b><strong><h2 class="w3-text-black">Recidencial I AT</h2></strong></b></center>
    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
      ...
      <div class="carousel-inner">
        <div class="carousel-item active">
          <img class="d-block w-100" src="img/c1sl.jpg" alt="First slide">
    </div>
    </div>
    ...
    <h4><strong>Detalles</strong></h4>
                  <div class="w3-row w3-large">
                    <div class="w3-col s6">
                      ...
                      <p><i class="fa fa-fw fa-arrows-alt"></i> Terreno (m²) 489</p>
                    </div>
                 </div>
    <hr>
    
    <h4><strong>Descripción</strong></h4>
    <p>Casa en venta en San Luis Potosi, cuenta con 3  niveles. En la parte de abajo cuenta con 2 recamaras,
    2 baños, 1 sala, 1 cocina, en el segundo nivel cuenta con 2 cuartos mas y 1 baño, y en el ultimo nivel cuenta 
    con un cuarto pequeño que es el almacen, en la parte de afuera cuenta con un estacionamiento. Todo para tu gran comodidad. </p>
    <hr>
    <h4><strong>Calcula tu Hipoteca</strong></h4>
    <p>$ 10,23000  Condominio en Venta</p>
    <hr>
  <!-- Contact -->
