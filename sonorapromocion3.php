...
<body>
  ...
  <div class="jumbotron">
    ...
    <center><b><strong><h2 class="w3-text-black">Santa Monica</h2></strong></b></center>
    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
      ...
      <div class="carousel-inner">
        <div class="carousel-item active">
          <img class="d-block w-100" src="img/p3son.jpg" alt="First slide">
        </div>
    </div>
    ...
    <p>Terreno irregular en renta, total o parcial; ubicado sobre Av.Durazno 75, Sonora.
       -Superficie Total: 9272.53 m2
       -Frente sobre Av. Del Carmen 215: 63.79 m
       -Frente sobre calle Luna: 96.4 m
       -Fondo: 389.47 m
