...
<body>
    ...
    readfile('./menu.html');
    ?>
    <a href="sonorat.php" class="btn btn-light btn-sm float-right"><i class="fa fa-reply"></i> regresar</a>
  ...
  <div class="jumbotron">
    ...
    <center><b><strong><h2 class="w3-text-black">La Libertad</h2></strong></b></center>
    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
      ...
      <div class="carousel-inner">
        <div class="carousel-item active">
          <img class="d-block w-100" src="img/t3son.jpg" alt="First slide">
        </div>
    </div>
    <h4><strong>Detalles</strong></h4>
                  <div class="w3-row w3-large">
                    <div class="w3-col s6">
                      <p><i class="fa fa-fw fa-compress"></i> Terreno (m²) 1,9459</p>
                    </div>
                 </div>
    <hr>
    
    <h4><strong>Descripción</strong></h4>
    <p>Terreno irregular en renta, total o parcial; ubicado sobre Av. Comonfort 069, Sonora.
       -Superficie Total: 1,9465.53 m2
       -Frente sobre Av. del Panteon 205: 55.99 m
       -Frente sobre calle Venustiano Carranza: 88.4 m
       -Fondo: 454.47 m
       -Venta: $ 1200.00 pesos por m2.
