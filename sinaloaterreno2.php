...
<body>
  ...
  <div class="jumbotron">
    ...
    <center><b><strong><h2 class="w3-text-black">Infonavit</h2></strong></b></center>
    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
      ...
      <div class="carousel-inner">
        <div class="carousel-item active">
          <img class="d-block w-100" src="img/t2sin.jpg" alt="First slide">
        </div>
    </div>
    <h4><strong>Detalles</strong></h4>
                  <div class="w3-row w3-large">
                    <div class="w3-col s6">
                      <p><i class="fa fa-fw fa-compress"></i> Terreno (m²) 2006</p>
                    </div>
                 </div>
    <hr>
    ...
    <p>Terreno irregular en renta, total o parcial; ubicado sobre Av. La Cruz 189, Sinaloa.
       -Superficie Total: 2,006.53 m2
       -Frente Av. Chavacanos 2995: 53.79 m
       -Frente sobre calle Niño perdido: 98.6 m
       -Fondo: 121.47 m
