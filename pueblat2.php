...
<body>
    ...
    readfile('./menu.html');
    ?>
    <a href="pueblat.php" class="btn btn-light btn-sm float-right"><i class="fa fa-reply"></i> regresar</a>
  ...
  <div class="jumbotron">
    ...
    <center><b><strong><h2 class="w3-text-black">Puebla</h2></strong></b></center>
    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
      ...
      <div class="carousel-inner">
        <div class="carousel-item active">
          <img class="d-block w-100" src="img/Terrenos/Puebla/Terreno 2/1.webp" alt="First slide">
        </div>
    </div>
    <h4><strong>Detalles</strong></h4>
                  <div class="w3-row w3-large">
                    <div class="w3-col s6">
                      <p><i class="fa fa-fw fa-compress"></i> Terreno (m²) 7762</p>
                    </div>
                 </div>
    <hr>
    
    <h4><strong>Descripción</strong></h4>
    <p>Terreno irregular en renta, total o parcial; ubicado sobre Av.Frontera, Puebla.
       -Superficie Total: 7,762.53 m2
       -Frente sobre Av. Jesus 64: 55.76 m
       -Frente sobre calle Hidalgo: 52.7 m
       -Fondo: 328.46 m
       -Venta: $ 420.00 pesos por m2.
