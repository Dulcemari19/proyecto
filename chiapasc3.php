...
<body>
  ...
  <div class="jumbotron">
    ...
    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
      ...
      <div class="carousel-inner">
        <div class="carousel-item active">
          <img class="d-block w-100" src="img/Chiapas/casa 3/01.jpg" alt="First slide">
    </div>
    </div>
    ...
    <p> Hermosa residencia en una de las colonias más upscale del estado de chiapas , 
        con una muy discreta ubicación. Cada espacio ha sido pensado en brindar el 
        mayor lujo y un estilo lo más sofisticado posible</p>
    <hr>
    <h4><strong>Calcula tu Hipoteca</strong></h4>
    <p>$ 6,000,000  Condominio en Venta</p>
    <hr>
  <!-- Contact -->
