...
<body>
  ...
  <div class="jumbotron">
    ...
    <center><b><strong><h2 class="w3-text-black">Carmen Roo</h2></strong></b></center>
    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
      ...
      <div class="carousel-inner">
        <div class="carousel-item active">
          <img class="d-block w-100" src="img/promocionq3.jpg" alt="First slide">
        </div>
    </div>
    ...
    <p>Terreno irregular en renta, total o parcial; ubicado sobre Av.San Francisco, sobre calle Matamoros, Quintana Roo.
       -Superficie Total: 9,442.23 m2
       -Frente sobre Av. San Francisco 1934: 52.96 m
       -Frente sobre calle Matamoros: 66.4 m
       -Fondo: 155.46 m
       -Venta: $ 75.00 pesos por m2.
