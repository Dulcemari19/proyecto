...
<body>
    ...
    readfile('./menu.html');
    ?>
    <a href="zacatecaso.php" class="btn btn-light btn-sm float-right"><i class="fa fa-reply"></i> regresar</a>
  ...
  <div class="jumbotron">
    ...
    <center><b><strong><h2 class="w3-text-black">Ritz-Carlton</h2></strong></b></center>
    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
      ...
      <div class="carousel-inner">
        <div class="carousel-item active">
          <img class="d-block w-100" src="img/o2zac.jpg" alt="First slide">
        </div>
    </div>
    ...
    <h4><strong>Detalles</strong></h4>
                  <div class="w3-row w3-large">
                    <div class="w3-col s6">
                      ...
                      <p><i class="fa fa-fw fa-compress"></i> Construidos (m²) 614</p>
                      <p><i class="fa fa-fw fa-arrows-alt"></i> Nivel 5</p>
                    </div>
                 </div>
    <hr>
    
    <h4><strong>Descripción</strong></h4>
    <p>Se renta Oficina Ritz-Carltoon. La oficina se encuentra en el 5 nivel con el número 992 y 
    cuenta con 612 m2 cuenta con 1 escritorios y sillas suficientes, asi como una sala pequeña, un baño y 
    pequeñas decoraciones, todo para su gran comodidad.</p>
    <hr>
    <h4><strong>Calcula tu Renta</strong></h4>
    <p>$ 11,900  Mensuales</p>
    <hr>
 <!-- Contact -->
