...
<body>
    ...
    readfile('./menu.html');
    ?>
    <a href="oaxacat.php" class="btn btn-light btn-sm float-right"><i class="fa fa-reply"></i> regresar</a>
  ...
  <div class="jumbotron">
    ...
    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
      ...
      <div class="carousel-inner">
        <div class="carousel-item active">
          <img class="d-block w-100" src="img/Terrenos/Oaxaca/Terreno 1/1.webp"alt="First slide">
        </div>
    </div>
    ...
    <p>Terreno irregular en renta, total o parcial; ubicado sobre Av. El Paso, Oaxaca.
       -Superficie Total: 6,642.53 m2
       -Frente sobre Av. 15 de Septiembre 314: 64.76 m
       -Frente sobre calle Maztuerzo:45.7 m
       -Fondo: 66.86 m
       -Venta: $ 780.00 pesos por m2.
