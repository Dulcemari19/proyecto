...
<body>
  ...
  <div class="jumbotron">
    ...
    <center><b><strong><h2 class="w3-text-black">Puente Quintana Roo</h2></strong></b></center>
    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
      ...
      <div class="carousel-inner">
        <div class="carousel-item active">
          <img class="d-block w-100" src="img/c3q.jpg" alt="First slide">
    </div>
    </div>
    ...
    <p>La casa cuenta con 2 niveles, en la parte de arriba con dos recamaras y cada recamara 
    cuenta con un baño en la parte de abajo cuenta con 2 recamaras mas y con un baño cada una,
    tiene un almacen, una sala y una cocina, en la parte de afuera cuenta con un pequeño jardin
    para tu gran comodidad.</p>
    <hr>
