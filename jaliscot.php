  ...
  <div class="card-deck mb-3 text-center">
    <div class="card mb-4 shadow-sm">
      ...
      <img src="img/Terrenos/Jalisco/Terreno 1/1.webp"width="300" alt="img_conference" class="rounded float-left mr-4">
        ...
        <a href="jaliscot1.php"><button type="button" class="btn btn-lg btn-block btn-outline-primary">Observar</button></a>
      </div>
      </div>
      <div class="card mb-4 shadow-sm">
      <div class="card-header">
      ...
      <img src="img/Terrenos/Jalisco/Terreno 2/01.webp"width="300" alt="img_conference" class="rounded float-left mr-4">
        ...
        <a href="jaliscot2.php"><button type="button" class="btn btn-lg btn-block btn-outline-primary">Observar</button></a>
      </div>
      </div>
      <div class="card mb-4 shadow-sm">
      <div class="card-header">
      ...
      <ul class="list-unstyled mt-3 mb-4">
        ...
        <a href="jaliscot3.php"><button type="button" class="btn btn-lg btn-block btn-outline-primary">Observar</button></a>
      </div>
    </div>