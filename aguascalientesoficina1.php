...
<body>
  ...
  <div class="jumbotron">
    ...
    <center><b><strong><h2 class="w3-text-black">San Telmo</h2></strong></b></center>
    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
      ...
      <div class="carousel-inner">
        <div class="carousel-item active">
          <img class="d-block w-100" src="img/oficina1.jpg" alt="First slide">
        </div>
    </div>
    ...
    <p>Se renta oficina en San Telmo business Tower La oficina se encuentra en el 3er nivel con el número 2360 y cuenta con 64.94 m2</p>
    <hr>
    <h4><strong>Calcula tu Renta</strong></h4>
    <p>$ 18,800  Mensuales</p>
    <hr>
  <!-- Contact -->
