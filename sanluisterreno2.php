...
<body>
    ...
    readfile('./menu.html');
    ?>
    <a href="sanluist.php" class="btn btn-light btn-sm float-right"><i class="fa fa-reply"></i> regresar</a>
  ...
  <div class="jumbotron">
    ...
    <center><b><strong><h2 class="w3-text-black">La 3 Habitacional</h2></strong></b></center>
    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
      ...
      <div class="carousel-inner">
        <div class="carousel-item active">
          <img class="d-block w-100" src="img/terreno2sanluis.jpg" alt="First slide">
        </div>
    </div>
    <h4><strong>Detalles</strong></h4>
                  <div class="w3-row w3-large">
                    <div class="w3-col s6">
                      <p><i class="fa fa-fw fa-compress"></i> Terreno (m²) 9442</p>
                    </div>
                 </div>
    <hr>
    
    <h4><strong>Descripción</strong></h4>
    <p>Terreno irregular en renta, total o parcial; ubicado sobre Av. Insurgente 1775 poniente y calle Morelos, San Luis Potosi.
       -Superficie Total:  9442.53 m2
       -Frente sobre Av. Insurgente 1775 poniente : 66.83 m
       -Frente sobre calle Morelos: 77.6 
       -Fondo: 145.56 m
       -Venta: $ 98.00 pesos por m2.
