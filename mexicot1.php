    ...
    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
      ...
      <div class="carousel-inner">
        <div class="carousel-item active">
          <img class="d-block w-100" src="img/Terrenos/Estado de México/Terreno 1/1.webp" alt="First slide">
        </div>
    </div>t1jal.jpg
    <h4><strong>Detalles</strong></h4>
                  <div class="w3-row w3-large">
                    <div class="w3-col s6">
                      <p><i class="fa fa-fw fa-compress"></i> Terreno (m²) 9842</p>
                    </div>
                 </div>
    <hr>
    
    <h4><strong>Descripción</strong></h4>
    <p>Terreno irregular en renta, total o parcial; ubicado sobre Av.super Mercado Estado de Mexico.
       -Superficie Total: 9,842.53 m2
       -Frente sobre Av. Monarcas 814: 64.76 m
       -Frente sobre calle Marruecos: 42.7 m
       -Fondo: 58.86 m
       -Venta: $ 750.00 pesos por m2.
