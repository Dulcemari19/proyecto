...
<body>
  ...
  <div class="jumbotron">
    ...
    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
      ...
      <div class="carousel-inner">
        <div class="carousel-item active">
          <img class="d-block w-100" src="img/Terrenos/Hidalgo/Terreno 2/1.webp"alt="First slide">
        </div>
    </div>
    ...
    <p>Terreno irregular en renta, total o parcial; ubicado sobre Av.Pasifico 87, Hidalgo.
       -Superficie Total: 6,698.53 m2
       -Frente sobre Av.Juarez 2914: 64.76 m
       -Frente sobre calle Bicentenario: 192.7 m
       -Fondo: 567.46 m
       -Venta: $ 460.00 pesos por m2.
