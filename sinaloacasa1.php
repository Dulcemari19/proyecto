...
<body>
    ...
    readfile('./menu.html');
    ?>
    <a href="sinaloac.php" class="btn btn-light btn-sm float-right"><i class="fa fa-reply"></i> regresar</a>
  ...
  <div class="jumbotron">
    ...
    <center><b><strong><h2 class="w3-text-black">Residencia las Flores</h2></strong></b></center>
    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
      ...
      <div class="carousel-inner">
        <div class="carousel-item active">
          <img class="d-block w-100" src="img/c1sin.jpg" alt="First slide">
    </div>
    </div>
    ...
    <h4><strong>Detalles</strong></h4>
                  <div class="w3-row w3-large">
                    <div class="w3-col s6">
                      ...
                      <p><i class="fa fa-fw fa-user-cog"></i> Construido (año) 2020</p>
                      <p><i class="fa fa-fw fa-compress"></i> Construidos (m²) 320 </p>
                      <p><i class="fa fa-fw fa-arrows-alt"></i> Terreno (m²) 269</p>
                    </div>
                 </div>
    <hr>
    
    <h4><strong>Descripción</strong></h4>
    <p>Casa en venta Residencia las Flores.cuenta con 2 niveles, en la parte de abajo cuenta con 2 recamaras  y 1 baño cada una,
    cuenta con 1 cocina, una sala, 1 comedor y un almacen. En la segunda planta se encuentran 2 recamaras con baño completo,
    por la parte de afuera cuenta con un estacionamiento, todo para su gran comodidad.</p>
    <hr>
    <h4><strong>Calcula tu Hipoteca</strong></h4>
    <p>$ 8,980,000  Condominio en Venta</p>
    <hr>
  <!-- Contact -->
