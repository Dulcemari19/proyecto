...
<body>
    ...
    readfile('./menu.html');
    ?>
    <a href="jaliscot.php" class="btn btn-light btn-sm float-right"><i class="fa fa-reply"></i> regresar</a>
  ...
  <div class="jumbotron">
    ...
    <h4><strong>Detalles</strong></h4>
                  <div class="w3-row w3-large">
                    <div class="w3-col s6">
                      <p><i class="fa fa-fw fa-compress"></i> Terreno (m²) 8765</p>
                    </div>
                 </div>
    <hr>
    
    <h4><strong>Descripción</strong></h4>
    <p>Terreno irregular en renta, total o  parcial; ubicado sobre Av.Hidalgo, Jalisco.
       -Superficie Total: 8,765.53 m2
       -Frente sobre Av. Chapultepec 214: 64.76 m
       -Frente sobre calle San Lorenzo: 782.7 m
       -Fondo: 228.46 m
