...
<body>
  ...
  <div class="jumbotron">
    ...
    <center><b><strong><h2 class="w3-text-black">The Brando</h2></strong></b></center>
    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
      ...
      <div class="carousel-inner">
        <div class="carousel-item active">
          <img class="d-block w-100" src="img/o1ver.jpg" alt="First slide">
        </div>
    </div>
    ...
    <p>Se renta Oficina The Brando. La oficina se encuentra en el 3 nivel con el número 79 y cuenta con 522 m2
    cuenta con 2 escritorios y sillas suficientes, asi como una  sala pequeña, un baño y pequeñas decoraciones,
