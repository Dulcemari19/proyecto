...
<body>
  ...
  <div class="jumbotron">
    ...
    <center><b><strong><h2 class="w3-text-black">El Dorado</h2></strong></b></center>
    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
      ...
      <div class="carousel-inner">
        <div class="carousel-item active">
          <img class="d-block w-100" src="img/c2sin.jpg" alt="First slide">
    </div>
    </div>
    ...
    <p>Casa en venta El Dorado.cuenta con 2 niveles, en la parte de abajo cuenta con  1 baño , cuenta con 1 cocina,
     una sala, 1 comedor y un almacen. En la segunda planta se encuentran 2 recamaras con baño completo,
    ...
    <p>$ 6,980,000  Condominio en Venta</p>
    <hr>
  <!-- Contact -->
