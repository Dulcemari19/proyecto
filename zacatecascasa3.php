...
<body>
    ...
    readfile('./menu.html');
    ?>
    <a href="zacatecasc.php" class="btn btn-light btn-sm float-right"><i class="fa fa-reply"></i> regresar</a>
  ...
  <div class="jumbotron">
    ...
    <center><b><strong><h2 class="w3-text-black">Real Zaz</h2></strong></b></center>
    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
      ...
      <div class="carousel-inner">
        <div class="carousel-item active">
          <img class="d-block w-100" src="img/c3zac.jpg" alt="First slide">
    </div>
    </div>
    ...
    <h4><strong>Detalles</strong></h4>
                  <div class="w3-row w3-large">
                    <div class="w3-col s6">
                      ...
                      <p><i class="fa fa-fw fa-door-open"></i> 6 Habitaciones(en total)</p>
                      <p><i class="fa fa-fw fa-toilet"></i> 4 baños</p>
                      <p><i class="fa fa-fw fa-warehouse"></i> Almacen </p>
                      <p><i class="fa fa-fw fa-user-cog"></i> Construido (año) 2010</p>
                      <p><i class="fa fa-fw fa-compress"></i> Construidos (m²) 764 </p>
                      <p><i class="fa fa-fw fa-arrows-alt"></i> Terreno (m²) 449</p>
                    </div>
                 </div>
    <hr>
    
    <h4><strong>Descripción</strong></h4>
    <p>Casa en venta Real Zaz. Cuenta con 2 niveles, en la planta de abajo cuenta concuenta  con 2 recamaras,
     1 baño cada recamara , cuenta con 1 cocina, una sala, 1 comedor y un almacen, en la segunda planta que 
     es la de arriba cuenta con 2 recamaras y un baño en cada una. Por la parte de afuera cuenta con un 
     estacionamiento, y un pequeño Jardin todo para su gran comodidad.</p>
    <hr>
    <h4><strong>Calcula tu Hipoteca</strong></h4>
    <p>$ 52,000  Condominio en Venta</p>
    <hr>
 <!-- Contact -->
