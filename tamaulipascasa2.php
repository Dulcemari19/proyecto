...
<body>
    ...
    readfile('./menu.html');
    ?>
    <a href="tamaulipasc.php" class="btn btn-light btn-sm float-right"><i class="fa fa-reply"></i> regresar</a>
  ...
  <div class="jumbotron">
    ...
    <center><b><strong><h2 class="w3-text-black">Residencial El Sol</h2></strong></b></center>
    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
      ...
      <div class="carousel-inner">
        <div class="carousel-item active">
          <img class="d-block w-100" src="img/c2tam.jpeg" alt="First slide">
    </div>
    </div>
    ...
    <h4><strong>Detalles</strong></h4>
                  <div class="w3-row w3-large">
                    <div class="w3-col s6">
                      ...
                      <p><i class="fa fa-fw fa-user-cog"></i> Construido (año) 2013</p>
                      <p><i class="fa fa-fw fa-compress"></i> Construidos (m²) 534 </p>
                      <p><i class="fa fa-fw fa-arrows-alt"></i> Terreno (m²) 239</p>
                    </div>
                 </div>
    <hr>
    
    <h4><strong>Descripción</strong></h4>
    <p>Casa en renta Residencial El Sol .Cuenta con 2 niveles, en la plana de arriba cuenta con 2 recamaras 
    y 1 baño, en la planta de abajo cuenta con 1 cocina, una sala, 1 comedor y un almacen. 
    ...
    <p>$ 35,790  Condominio en Renta</p>
    <hr>
 <!-- Contact -->
