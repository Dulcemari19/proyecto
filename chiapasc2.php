...
<body>
  ...
  <div class="jumbotron">
    ...
    <center><b><strong><h2 class="w3-text-black">Casa la Primavera</h2></strong></b></center>
    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
      ...
      <div class="carousel-inner">
        <div class="carousel-item active">
          <img class="d-block w-100" src="img/Chiapas/casa 2/1.jpg" alt="First slide">
    </div>
    </div>
    ...
    <p> Hermosa residencia en una de las colonias más upscale del estado de Chiapas, 
        con una muy discreta ubicación. Cada espacio ha sido pensado en brindar 
        el mayor lujo y un estilo lo más sofisticado posible</p>
    <hr>
