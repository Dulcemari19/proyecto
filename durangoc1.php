...
<body>
    ...
    readfile('./menu.html');
    ?>
    <a href="durangoc.php" class="btn btn-light btn-sm float-right"><i class="fa fa-reply"></i> regresar</a>
  ...
  <div class="jumbotron">
    ...
    <center><b><strong><h2 class="w3-text-black">Recidencia Mercurio</h2></strong></b></center>
    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
      ...
      <div class="carousel-inner">
        <div class="carousel-item active">
          <img class="d-block w-100" src="img/Durango/Casa 1/1.webp" alt="First slide">
    </div>
    </div>
    ...
    <p> Hermosa residencia  con una muy discreta ubicación. 
    Cada espacio ha sido pensado en brindar el mayor 
    lujo y un estilo lo más sofisticado posible</p>
    <hr>
