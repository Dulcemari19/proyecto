...
<body>
    ...
    readfile('./menu.html');
    ?>
    <a href="chiapast.php" class="btn btn-light btn-sm float-right"><i class="fa fa-reply"></i> regresar</a>
  ...
  <div class="jumbotron">
    ...
    <center><b><strong><h2 class="w3-text-black">Chiapas T.</h2></strong></b></center>
    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
      ...
      <div class="carousel-inner">
        <div class="carousel-item active">
          <img class="d-block w-100" src="img/Terrenos/Chiapas/Terreno 3/1.webp" alt="First slide">
        </div>
    </div>
    ...
    <p>Terreno irregular en renta, total o parcial; ubicado sobre Av.Chavacano, Chiapas.
       -Superficie Total: 8,128.53 m2
       -Frente sobre Av. Pensamiento 624: 64.76 m
       -Frente sobre calle Deportiva: 162.7 m
       -Fondo: 984.46 m
