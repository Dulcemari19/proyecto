...
<body>
  ...
  <div class="jumbotron">
    ...
    <center><b><strong><h2 class="w3-text-black">Monte Grande</h2></strong></b></center>
    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
      ...
      <div class="carousel-inner">
        <div class="carousel-item active">
          <img class="d-block w-100" src="img/p1tlax.jpg" alt="First slide">
    </div>
    </div>
    ...
    <p>Casa en venta Monte Grande.Cuenta con 1 nivel, cuenta con 2 recamaras  y 1 baño, cuenta con
     1 cocina, una sala, 1 comedor y un almacen. Por la parte de afuera cuenta con un estacionamiento,
    Todo para su gran comodidad.</p>
    <hr>
    <h4><strong>Calcula tu Hipoteca</strong></h4>
    <p>$ 15,380 Condominio en Venta</p>
    <hr>
 <!-- Contact -->
