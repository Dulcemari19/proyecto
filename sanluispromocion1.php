...
<body>
  ...
  <div class="jumbotron">
    ...
    <center><b><strong><h2 class="w3-text-black">Hipoteca San Luis</h2></strong></b></center>
    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
      ...
      <div class="carousel-inner">
        <div class="carousel-item active">
          <img class="d-block w-100" src="img/p1csl.jpg" alt="First slide">
        </div>
    </div>
    ...
    <h4><strong>Detalles</strong></h4>
                  <div class="w3-row w3-large">
                    <div class="w3-col s6">
                      ...
                      <p><i class="fa fa-fw fa-user-cog"></i> Construido (año) 2016</p>
    ...
    <p>Hipoteca San Luis  se encuentra ubicado en San Luis Potosi,es de 2 plantas, en la planta de abo cuenta con 2 recamaras,
    1 baño, una sala, una cocina,1 comedor, en la Segunda planta cuenta con 2 Recamaras y 1 baño, una pequeña sala,
    tiene como servicios agua potable, Gas  y Energia Electrica para tu gran comodidad. </p>
    <hr>
