...
<body>
  ...
  <div class="jumbotron">
    ...
    <center><b><strong><h2 class="w3-text-black">Bacalar</h2></strong></b></center>
    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
      ...
      <div class="carousel-inner">
        <div class="carousel-item active">
          <img class="d-block w-100" src="img/promocionq1.jpg" alt="First slide">
        </div>
    </div>
    ...
    <p>Bacalar se encuentra ubicado en Quintana Roo,es de una planta, cuenta con 2 recamaras y 1 baño cada habitacion,
    cuenta con 1 estacionamiento, 1 cocina 1 sala, tiene como servicios agua potable, Gas  y Energia Electrica para tu gran comodidad. </p>
    <hr>
    <h4><strong>Calcula tu Renta</strong></h4>
    <p>$ 15,600  Mensuales</p>
    <hr>
 <!-- Contact -->
