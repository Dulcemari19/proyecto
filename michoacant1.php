...
<body>
    ...
    readfile('./menu.html');
    ?>
    <a href="michoacant.php" class="btn btn-light btn-sm float-right"><i class="fa fa-reply"></i> regresar</a>
    ...
    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
      ...
      <div class="carousel-inner">
        <div class="carousel-item active">
          <img class="d-block w-100" src="img/Terrenos/Michoacán/Terreno 1/1.webp" alt="First slide">
        </div>
    </div>
    <h4><strong>Detalles</strong></h4>
                  <div class="w3-row w3-large">
                    <div class="w3-col s6">
                      <p><i class="fa fa-fw fa-compress"></i> Terreno (m²) 9666</p>
                    </div>
                 </div>
    <hr>
    
    <h4><strong>Descripción</strong></h4>
    <p>Terreno irregular en renta, total o parcial; ubicado sobre Av.Lazaro Cardenaz, Michoacan.
       -Superficie Total: 9,666.53 m2
       -Frente sobre Av. San Pablo 234: 52.76 m
       -Frente sobre calle Calvario: 367.7 m
       -Fondo: 418.26 m
       -Venta: $ 300.00 pesos por m2.
