...
<body>
  ...
  <div class="jumbotron">
    ...
    <center><b><strong><h2 class="w3-text-black">La Milpa</h2></strong></b></center>
    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
      ...
      <div class="carousel-inner">
        <div class="carousel-item active">
          <img class="d-block w-100" src="img/p3tab.jpg" alt="First slide">
        </div>
    </div>
    ...
    <p>Terreno irregular en renta, total o parcial; ubicado sobre Av.Frontera 679, Tabasco.
       -Superficie Total: 9,752.53 m2
       -Frente sobre Av. 3 Marias 145: 69.79 m
       -Frente sobre calle Americas: 76.4 m
       -Fondo: 389.47 m
