...
<body>
  ...
  <div class="card-deck mb-3 text-center">
    <div class="card mb-4 shadow-sm">
      ...
      <div class="card-body">
      <img src="img/Hoteles/Nayarit/Hotel 1/1.webp"width="300" alt="img_conference" class="rounded float-left mr-4">
      ...
      <div class="card-body">
      <img src="img/Hoteles/Nayarit/Hotel 2/1.webp"width="300" alt="img_conference" class="rounded float-left mr-4">
        <ul class="list-unstyled mt-3 mb-4">
          <li>"El compromiso </li>
          <li>es Contigo"</li>
          <li>La mejor calidad aqui en SDI</li>
      ...
      <div class="card-body">
      <img src="img/Hoteles/Nayarit/Hotel 3/1.webp"width="300" alt="img_conference" class="rounded float-left mr-4"> 
      <ul class="list-unstyled mt-3 mb-4">
          <li>"El compromiso </li>
          <li>es Contigo"</li>
          <li>La mejor calidad aqui en SDI</li>
