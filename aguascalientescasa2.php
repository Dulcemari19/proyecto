...
<body>
  ...
  <div class="jumbotron">
    ...
    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
      ...
      <div class="carousel-inner">
        <div class="carousel-item active">
          <img class="d-block w-100" src="img/casa2.jpg" alt="First slide">
        </div>
    </div>
    ...
    <h4><strong>Detalles</strong></h4>
                  <div class="w3-row w3-large">
                    <div class="w3-col s6">
                      ...
                      <p><i class="fa fa-fw fa-swimmer"></i> Alberca </p>
    ...
    <p>Casa en venta en Campestre Residencial con Roof Garden. En la primera planta se encuentra sala, comedor, cocina,
    estudio, cuarto de lavado, patio trasero y cochera para dos autos. En la segunda planta se encuentra
    cinco recamaras con baño completo y closets, vertedero, espacio para blancos y sala de televisión.</p>
    <hr>
    <h4><strong>Calcula tu Hipoteca</strong></h4>
    <p>$ 4,390,000 Casa en Venta</p>
    <hr>
 <!-- Contact -->
