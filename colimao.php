  ...
  <div class="card-deck mb-3 text-center">
    <div class="card mb-4 shadow-sm">
      ...
      <img src="img/o1col.jpg"width="300" alt="img_conference" class="rounded float-left mr-4">
        ...
        <a href="colimao1.php"><button type="button" class="btn btn-lg btn-block btn-outline-primary">Observar</button></a>
      </div>
      </div>
      <div class="card mb-4 shadow-sm">
      <div class="card-header">
      ...
      <img src="img/o2col.jpg"width="300" alt="img_conference" class="rounded float-left mr-4">
        ...
        <a href="colimao2.php"><button type="button" class="btn btn-lg btn-block btn-outline-primary">Observar</button></a>
      </div>
      </div>
      <div class="card mb-4 shadow-sm">
      <div class="card-header">
