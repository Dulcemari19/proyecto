...
<body>
    ...
    readfile('./menu.html');
    ?>
    <a href="sinaloao.php" class="btn btn-light btn-sm float-right"><i class="fa fa-reply"></i> regresar</a>
  ...
  <div class="jumbotron">
    ...
    <center><b><strong><h2 class="w3-text-black">Oficinas Sinaloa</h2></strong></b></center>
    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
      ...
      <div class="carousel-inner">
        <div class="carousel-item active">
          <img class="d-block w-100" src="img/o1sin.jpg" alt="First slide">
        </div>
    </div>
    ...
    <h4><strong>Detalles</strong></h4>
                  <div class="w3-row w3-large">
                    <div class="w3-col s6">
                      ...
                      <p><i class="fa fa-fw fa-compress"></i> Construidos (m²) 99 </p>
    ...
    <p>Se renta Oficinas Sinaloa. La oficina se encuentra en el 3er nivel con el número 1172 y cuenta con 99 m2
    cuenta con escritorios y sillas suficientes, asi como una  sala pequeña y pequeñas decoraciones, todopara su gran comodidad.</p>
    <hr>
    <h4><strong>Calcula tu Renta</strong></h4>
    <p>$ 19,700  Mensuales</p>
    <hr>
  <!-- Contact -->
