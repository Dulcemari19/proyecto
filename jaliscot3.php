    ...
    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
      ...
      <div class="carousel-inner">
        <div class="carousel-item active">
          <img class="d-block w-100" src="img/Terrenos/Baja california/Terreno 3/1.webp"alt="First slide">
        </div>
    </div>t1jal.jpg
    <h4><strong>Detalles</strong></h4>
                  <div class="w3-row w3-large">
                    <div class="w3-col s6">
                      <p><i class="fa fa-fw fa-compress"></i> Terreno (m²) 6642</p>
                    </div>
                 </div>
    <hr>
    
    <h4><strong>Descripción</strong></h4>
    <p>Terreno irregular en renta, total o parcial; ubicado sobre Av.Comonfort 39, Jalisco.
       -Superficie Total: 6,642.53 m2
       -Frente sobre Av. Morelos 514: 88.76 m
       -Frente sobre calle Las Flores: 82.7 m
       -Fondo: 48.46 m
