...
<body>
    ...
    readfile('./menu.html');
    ?>
    <a href="yucatant.php" class="btn btn-light btn-sm float-right"><i class="fa fa-reply"></i> regresar</a>
  ...
  <div class="jumbotron">
    ...
    <center><b><strong><h2 class="w3-text-black">La Concepcion</h2></strong></b></center>
    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
      ...
      <div class="carousel-inner">
        <div class="carousel-item active">
          <img class="d-block w-100" src="img/t3yuc.jpg" alt="First slide">
        </div>
    </div>
    <h4><strong>Detalles</strong></h4>
                  <div class="w3-row w3-large">
                    <div class="w3-col s6">
                      <p><i class="fa fa-fw fa-compress"></i> Terreno (m²) 40937</p>
                    </div>
                 </div>
    <hr>
    
    <h4><strong>Descripción</strong></h4>
    <p>Terreno irregular en renta, total o parcial; ubicado sobre Av. Campesinos 111, Yucatan.
       -Superficie Total: 40,937.53 m2
       -Frente sobre Av. Oriente N.2  640: 33.79 m
       -Frente sobre calle 5 de Febrero : 43.4 m
       -Fondo: 998.47 m
       -Venta: $ 3100.00 pesos por m2.
