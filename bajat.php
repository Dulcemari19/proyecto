  ...
  <div class="card-deck mb-3 text-center">
    <div class="card mb-4 shadow-sm">
      ...
      <img src="img/Terrenos/Baja california/Terreno 2/01.webp"width="300" alt="img_conference" class="rounded float-left mr-4">
        ...
        <a href="bajat2.php"><button type="button" class="btn btn-lg btn-block btn-outline-primary">Observar</button></a>
      </div>
      </div>
      <div class="card mb-4 shadow-sm">
      <div class="card-header">
        <h4 class="my-0 font-weight-normal">Terreno Agricola</h4>
      </div>
      <div class="card-body">
      <img src="img/Terrenos/Baja california/Terreno 3/1.jpg"width="300" alt="img_conference" class="rounded float-left mr-4"> 
      <ul class="list-unstyled mt-3 mb-4">
          <li>"El compromiso </li>
          <li>es Contigo"</li>
          <li>La mejor calidad aqui en SDI</li>
        </ul>
        <a href="bajat3.php"><button type="button" class="btn btn-lg btn-block btn-outline-primary">Observar</button></a>
      </div>
    </div>