...
<body>
  ...
  <div class="jumbotron">
    ...
    <center><b><strong><h2 class="w3-text-black">Lote Juarez</h2></strong></b></center>
    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
      ...
      <div class="carousel-inner">
        <div class="carousel-item active">
          <img class="d-block w-100" src="img/t2tam.jpg" alt="First slide">
        </div>
    </div>
    <h4><strong>Detalles</strong></h4>
                  <div class="w3-row w3-large">
                    <div class="w3-col s6">
                      <p><i class="fa fa-fw fa-compress"></i> Terreno (m²) 9731</p>
                    </div>
                 </div>
    <hr>
    ...
    <p>Terreno irregular en renta, total o parcial; ubicado sobre Av.El Parque 202, Tamaulipas.
       -Superficie Total: 9,731.53 m2
       -Frente sobre Av.Metropolitana 201: 63.79 m
       -Frente sobre calle Concepcion: 223.4 m
       -Fondo: 954.47 m
       -Venta: $ 1000.00 pesos por m2.
