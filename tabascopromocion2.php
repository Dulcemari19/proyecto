...
<body>
  ...
  <div class="jumbotron">
    ...
    <center><b><strong><h2 class="w3-text-black">5 Estrellas</h2></strong></b></center>
    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
      ...
      <div class="carousel-inner">
        <div class="carousel-item active">
          <img class="d-block w-100" src="img/p2tab.jpg" alt="First slide">
        </div>
    </div>
    ...
    <h4><strong>Detalles</strong></h4>
                  <div class="w3-row w3-large">
                    <div class="w3-col s6">
                      ...
                      <p><i class="fa fa-fw fa-user-cog"></i> Construido (año) 2006</p>
                      <p><i class="fa fa-fw fa-compress"></i> Construidos (m²) 451 </p>
                      <p><i class="fa fa-fw fa-arrows-alt"></i> Nivel 6</p>
                    </div>
                 </div>
    <hr>
    
    <h4><strong>Descripción</strong></h4>
    <p>Hotel 5 Estrellas renta de departamento por dia, zona de Tabasco. Departamento con elevador
