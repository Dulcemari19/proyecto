...
<body>
    ...
    readfile('./menu.html');
    ?>
    <a href="colimao.php" class="btn btn-light btn-sm float-right"><i class="fa fa-reply"></i> regresar</a>
  ...
  <div class="jumbotron">
    ...
    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
      ...
      <div class="carousel-inner">
        <div class="carousel-item active">
          <img class="d-block w-100" src="img/o3col.jpg" alt="First slide">
        </div>
    </div>
    ...
    <h4><strong>Detalles</strong></h4>
                  <div class="w3-row w3-large">
                    <div class="w3-col s6">
                      ...
                      <p><i class="fa fa-fw fa-compress"></i> Construidos (m²) 628</p>
    ...
    <p>Se renta Oficina. La oficina se encuentra en el 3 nivel con el número 77 y cuenta con 628 m2
