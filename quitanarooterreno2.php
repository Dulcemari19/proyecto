...
<body>
    ...
    readfile('./menu.html');
    ?>
    <a href="quintanarooterreno2.php" class="btn btn-light btn-sm float-right"><i class="fa fa-reply"></i> regresar</a>
  ...
  <div class="jumbotron">
    ...
    <center><b><strong><h2 class="w3-text-black">Terreno Playa del Carmen</h2></strong></b></center>
    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
      ...
      <div class="carousel-inner">
        <div class="carousel-item active">
          <img class="d-block w-100" src="img/terreno2quintanaroo.jpg" alt="First slide">
        </div>
    </div>
    <h4><strong>Detalles</strong></h4>
                  <div class="w3-row w3-large">
                    <div class="w3-col s6">
                      <p><i class="fa fa-fw fa-compress"></i> Terreno (m²) 1442</p>
                    </div>
                 </div>
    <hr>
    
    <h4><strong>Descripción</strong></h4>
    <p>Terreno irregular en renta, total o parcial; ubicado sobre Av.calzada sobre calle san juan, Cancun Quintana Roo.
       -Superficie Total: 9,345.33 m2
       -Frente sobre Av. Idependencia 2202: 84.76 m
       -Frente sobre calle belen: 82.7 m
       -Fondo: 232.46 m
       -Venta: $ 55.00 pesos por m2.
