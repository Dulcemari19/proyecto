...
<body>
  ...
  <div class="jumbotron">
    ...
    <center><b><strong><h2 class="w3-text-black">Bosques del Prado Norte</h2></strong></b></center>
    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
      ...
      <div class="carousel-inner">
        <div class="carousel-item active">
          <img class="d-block w-100" src="img/promocion2.jpg" alt="First slide">
        </div>
    </div>
    ...
    <h4><strong>Detalles</strong></h4>
                  <div class="w3-row w3-large">
                    <div class="w3-col s6">
                      ...
                      <p><i class="fa fa-fw fa-compress"></i> Construidos (m²) 101 </p>
    ...
    <p>HURBAN renta departamento zona San Telmo. Excelente ubicación a pasos de Plaza San Telmo, 
    departamento con elevador y 2 cajones de estacionamiento techado. Cuenta con área de sala y 
    comedor, cocina integral con barra, 2 recámaras c/u con closet, 2 baños completos. El edificio 
    está equipado con paneles solares y calentador solar.</p>
    <hr>
