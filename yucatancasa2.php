...
<body>
    ...
    readfile('./menu.html');
    ?>
    <a href="yucatanc.php" class="btn btn-light btn-sm float-right"><i class="fa fa-reply"></i> regresar</a>
  ...
  <div class="jumbotron">
    ...
    <center><b><strong><h2 class="w3-text-black">Residencial Yucatan</h2></strong></b></center>
    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
      ...
      <div class="carousel-inner">
        <div class="carousel-item active">
          <img class="d-block w-100" src="img/c2yuc.jpg" alt="First slide">
    </div>
    </div>
    ...
    <h4><strong>Detalles</strong></h4>
                  <div class="w3-row w3-large">
                    <div class="w3-col s6">
                      ...
                      <p><i class="fa fa-fw fa-compress"></i> Construidos (m²) 632 </p>
                      <p><i class="fa fa-fw fa-arrows-alt"></i> Terreno (m²) 569</p>
                    </div>
                 </div>
    <hr>
    
    <h4><strong>Descripción</strong></h4>
    <p>Casa en venta Residencial Yucatan.Cuenta con 2 niveles, en la planta de abajo cuenta con 2 recamaras,
    1 baño, 1 cocina, una sala, 1 comedor y un almacen. En la segunda planta, la parte de arriba cuenta con
    2 recamaras y 1 baño. Por la parte de afuera cuenta con un estacionamiento, y un pequeño Jardin. 
    Todo para su gran comodidad.</p>
    <hr>
    <h4><strong>Calcula tu Hipoteca</strong></h4>
    <p>$ 47,230  Condominio en Venta</p>
    <hr>
  <!-- Contact -->
