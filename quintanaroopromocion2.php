...
<body>
    ...
    readfile('./menu.html');
    ?>
    <a href="quintanaroop.php" class="btn btn-light btn-sm float-right"><i class="fa fa-reply"></i> regresar</a>
  ...
  <div class="jumbotron">
    ...
    <center><b><strong><h2 class="w3-text-black">Posada Luna del Sur</h2></strong></b></center>
    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
      ...
      <div class="carousel-inner">
        <div class="carousel-item active">
          <img class="d-block w-100" src="img/promocionq2.jpg" alt="First slide">
        </div>
    </div>
    ...
    <h4><strong>Detalles</strong></h4>
                  <div class="w3-row w3-large">
                    <div class="w3-col s6">
                      <p><i class="fa fa-fw fa-bed"></i> 2 camas</p>
                      <p><i class="fa fa-fw fa-door-open"></i> 1 Habitaciones(en total)</p>
                      <p><i class="fa fa-fw fa-toilet"></i> 1 Baño</p>
    ...
    <p>Posada Luna del Sur se encuenta ubicada en Quintana Roo, cuenta con a renta de 1 habitacion con 2 camas,
    1 baño 1 mini armario, como servicios cuenta con Enegia electrica y Agua potable. Todo para una exelente comodidad.</p>
    <hr>
