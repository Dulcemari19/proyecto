...
<body>
  ...
  <div class="jumbotron">
    ...
    <center><b><strong><h2 class="w3-text-black">“Gancho” comercial</h2></strong></b></center>
    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
      ...
      <div class="carousel-inner">
        <div class="carousel-item active">
          <img class="d-block w-100" src="img/o1zac.jpg" alt="First slide">
        </div>
    </div>
    ...
    <h4><strong>Detalles</strong></h4>
                  <div class="w3-row w3-large">
                    <div class="w3-col s6">
                      ...
                      <p><i class="fa fa-fw fa-compress"></i> Construidos (m²) 682</p>
    ...
    <p>Se renta Oficina “Gancho” comercial. La oficina se encuentra en el 3 nivel con el número 62 y 
    cuenta con 682 m2 cuenta con 1 escritorios y sillas suficientes, asi como una vitrina, un baño y 
