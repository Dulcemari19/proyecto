...
<body>
  ...
  <div class="jumbotron">
    ...
    <center><b><strong><h2 class="w3-text-black">Plaza Zacateca</h2></strong></b></center>
    ...
    <h4><strong>Detalles</strong></h4>
                  <div class="w3-row w3-large">
                    <div class="w3-col s6">
                      ...
                      <p><i class="fa fa-fw fa-user-cog"></i> Construido (año) 2008</p>
    ...
    <p>Casa en venta Plaza Zacateca. Cuenta con 2 niveles, en la planta de abajo cuenta concuenta  con 1 recamara,
    ...
    <p>$ 46,240  Condominio en Venta</p>
    <hr>
  <!-- Contact -->
