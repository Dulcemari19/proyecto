...
<body>
  ...
  <div class="jumbotron">
    ...
    <center><b><strong><h2 class="w3-text-black">Recidencia Robles</h2></strong></b></center>
    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
      ...
      <div class="carousel-inner">
        <div class="carousel-item active">
          <img class="d-block w-100" src="img/Campeche/Casa 1/1.webp" alt="First slide">
    </div>
    </div>
    ...
    tiene un almacen, una sala y una cocina, en la parte de afuera cuenta con un pequeño jardin.</p>
    <hr>
    <h4><strong>Calcula tu Hipoteca</strong></h4>
    <p>$ 5,000,000  Condominio en Venta</p>
    <hr>
  <!-- Contact -->
