...
<body>
  ...
  <div class="jumbotron">
    ...
    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
      ...
      <div class="carousel-inner">
        <div class="carousel-item active">
          <img class="d-block w-100" src="img/o1bcs.jpg" alt="First slide">
        </div>
    </div>
    ...
    <p>Se renta Oficina. La oficina se encuentra en el 2 nivel con el número 442 y cuenta con 422 m2
