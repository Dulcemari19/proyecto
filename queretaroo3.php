...
<body>
    ...
    readfile('./menu.html');
    ?>
    <a href="hidalgoo.php" class="btn btn-light btn-sm float-right"><i class="fa fa-reply"></i> regresar</a>
  ...
  <div class="jumbotron">
    ...
    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
      ...
      <div class="carousel-inner">
        <div class="carousel-item active">
          <img class="d-block w-100" src="img/Oficinas/Hidalgo/Oficina 1/1.webp" alt="First slide">
        </div>
    </div>
    ...
    <h4><strong>Detalles</strong></h4>
                  <div class="w3-row w3-large">
                    <div class="w3-col s6">
                      ...
                      <p><i class="fa fa-fw fa-compress"></i> Construidos (m²) 75 </p>
    ...
    <p>Se renta oficina, La oficina se encuentra en el 3er nivel con el número 2872 y cuenta con 75 m2</p>
    <hr>
    <h4><strong>Calcula tu Renta</strong></h4>
    <p>$ 15,800  Mensuales</p>
    <hr>
     <!-- Contact -->
...
<body>
    ...
    readfile('./menu.html');
    ?>
    <a href="quereraroo.php" class="btn btn-light btn-sm float-right"><i class="fa fa-reply"></i> regresar</a>
    <img src="img/sdihouse.png"width="250" alt="img_conference" class="rounded float-left mr-4"></td><div class="jumbotron text-center">
     <h1>SDI House</h1>
      <p>¿Por cuánto tiempo me quedo con una propiedad? Mi preferencia: para siempre</p> 
    </div>
  ...
  <div class="jumbotron">
    ...
    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
      ...
      <div class="carousel-inner">
        <div class="carousel-item active">
          <img class="d-block w-100" src="img/Oficinas/Queretaro/Oficina 3/1.webp" alt="First slide">
        </div>
    </div>
      <h4><strong>Servicios</strong></h4>
              <div class="w3-row w3-large">
