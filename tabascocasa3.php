...
<body>
  ...
  <div class="jumbotron">
    ...
    <center><b><strong><h2 class="w3-text-black">Casas Moda</h2></strong></b></center>
    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
      ...
      <div class="carousel-inner">
        <div class="carousel-item active">
          <img class="d-block w-100" src="img/c3tab.jpg" alt="First slide">
    </div>
    </div>
    ...
    <h4><strong>Detalles</strong></h4>
                  <div class="w3-row w3-large">
                    <div class="w3-col s6">
                      ...
                      <p><i class="fa fa-fw fa-arrows-alt"></i> Terreno (m²) 563</p>
                    </div>
                 </div>
    <hr>
    
    <h4><strong>Descripción</strong></h4>
    <p>Casa en venta Casas Moda.Cuenta con 2 niveles, En la parte de abajo Cuenta con 1 recamaras  y
    1 baño, cuenta con 1 cocina, una sala, 1 comedor y un almacen. En el Segundo nivel cuenta con 2 recamaras y 1 baño
    Por la parte de afuera cuenta con un estacionamiento, un almacen, y un pequeño Jardin todo para su gran comodidad.</p>
    <hr>
    <h4><strong>Calcula tu Hipoteca</strong></h4>
    <p>$ 28,990  Condominio en Venta</p>
    <hr>
  <!-- Contact -->
