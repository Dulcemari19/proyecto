...
<body>
    ...
    readfile('./menu.html');
    ?>
    <a href="jaliscoo.php" class="btn btn-light btn-sm float-right"><i class="fa fa-reply"></i> regresar</a>
    ...
    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
      ...
      <div class="carousel-inner">
        <div class="carousel-item active">
          <img class="d-block w-100" src="img/Oficinas/Jalisco/Oficina 3/1.webp" alt="First slide">
        </div>
    </div>
