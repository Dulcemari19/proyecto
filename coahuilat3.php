...
<body>
    ...
    readfile('./menu.html');
    ?>
    <a href="coahuilat.php" class="btn btn-light btn-sm float-right"><i class="fa fa-reply"></i> regresar</a>
    ...
    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
      ...
      <div class="carousel-inner">
        <div class="carousel-item active">
          <img class="d-block w-100" src="img/Terrenos/Coahuila/Terreno 3/1.webp"alt="First slide">
        </div>
    </div>
    <h4><strong>Detalles</strong></h4>
                  <div class="w3-row w3-large">
                    <div class="w3-col s6">
                      <p><i class="fa fa-fw fa-compress"></i> Terreno (m²) 13564</p>
                    </div>
                 </div>
    <hr>
    
    <h4><strong>Descripción</strong></h4>
    <p>Terreno irregular en renta, total o parcial; ubicado sobre Av.Felipe Villanueva, Coahuila.
       -Superficie Total: 13,564.52 m2
       -Frente sobre Av.Puerto de Palos 639: 22.76 m
       -Frente sobre calle Nicolas Bravo: 569.7 m
       -Fondo: 678.66 m
       -Venta: $ 580.00 pesos por m2.
