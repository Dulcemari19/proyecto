...
<body>
    ...
    readfile('./menu.html');
    ?>
    <a href="sanluiso.php" class="btn btn-light btn-sm float-right"><i class="fa fa-reply"></i> regresar</a>
  ...
  <div class="jumbotron">
    ...
    <center><b><strong><h2 class="w3-text-black">Bienes Corporativo</h2></strong></b></center>
    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
      ...
      <div class="carousel-inner">
        <div class="carousel-item active">
          <img class="d-block w-100" src="img/oficina3sanluis.jpg" alt="First slide">
        </div>
    </div>
    ...
    <h4><strong>Detalles</strong></h4>
                  <div class="w3-row w3-large">
                    <div class="w3-col s6">
                      ...
                      <p><i class="fa fa-fw fa-compress"></i> Construidos (m²) 200 </p>
    ...
    <p>Se renta Bienes Corportivo, es una oficina que se encuentra ubicada en San luis Potosi esta se encuentra 
    en 2 niveles con el número 1356 y cuenta con 80.94 m2</p>
    <hr>
    <h4><strong>Calcula tu Renta</strong></h4>
    <p>$ 12,700  Mensuales</p>
    <hr>
 <!-- Contact -->
