...
<body>
    ...
    readfile('./menu.html');
    ?>
    <a href="ofertas.php" class="btn btn-light btn-sm float-right"><i class="fa fa-reply"></i> regresar</a>
     ...
     <h1>SDI House</h1>
      ...
      <div class="container">
        ...
        <div class="row">
            <div class="col-sm-4">
              <h3></h3>
             <img src="img/promocion1.jpg"width="200" alt="img_conference" class="rounded float-left mr-4">
            </div>
            <div class="col-sm-4">
              ...
              <div class="col-sm-4">
                  ...
                  <div class="row">
                    <div class="col-sm-4">
                      <h3></h3>
                     <img src="img/promocion2.jpg"width="200" alt="img_conference" class="rounded float-left mr-4">
                    </div>
                    <div class="col-sm-4">
                      <h4><strong>Servicios</strong></h4>
                      <div class="w3-row w3-large">
                      ...
                      <div class="col-sm-4">
                          ...
                          <div class="w3-row w3-large">
                            <div class="w3-col s6">
                              ...
                              <p><i class="fa fa-fw fa-table"></i> Estudio</p>
                              <p><i class="fa fa-fw fa-toilet"></i> Baño</p>
                              <p><i class="fa fa-fw fa-mug-hot"></i> Cocina </p>
                              <p><i class="fa fa-fw fa-couch"></i> Sala </p>
                              <p><i class="fa fa-fw fa-mortar-pestle"></i> Comedor </p>
                          ...
                          <div class="row">
                            <div class="col-sm-4">
                              <h3></h3>
                             <img src="img/promocion3.jpg"width="200" alt="img_conference" class="rounded float-left mr-4">
                            </div>
                            <div class="col-sm-4">
                              <h4><strong>Servicios</strong></h4>
                              <div class="w3-row w3-large">
