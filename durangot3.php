...
<body>
  ...
  <div class="jumbotron">
    ...
    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
      ...
      <div class="carousel-inner">
        <div class="carousel-item active">
          <img class="d-block w-100" src="img/Terrenos/Durango/Terreno 3/1.webp"alt="First slide">
        </div>
    </div>
    ...
    <p>Terreno irregular en renta, total o parcial; ubicado sobre Av. El Sol, Durango.
       -Superficie Total: 9,386.53 m2
       -Frente sobre Av. Moctezuma 14: 32.76 m
       -Frente sobre calle Frontera: 386.7 m
       -Fondo: 128.26 m
