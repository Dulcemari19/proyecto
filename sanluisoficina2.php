...
<body>
  ...
  <div class="jumbotron">
    ...
    <center><b><strong><h2 class="w3-text-black">Oficinas L.P</h2></strong></b></center>
    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
      ...
      <div class="carousel-inner">
        <div class="carousel-item active">
          <img class="d-block w-100" src="img/oficina2sanluis.jpg" alt="First slide">
        </div>
    </div>
    ...
    <p>Se renta oficina L.P, se encuentra ubicada en San luis Potosi esta se encuentra en 2 niveles
    con el número 1356 y cuenta con 70.94 m2</p>
    <hr>
    <h4><strong>Calcula tu Renta</strong></h4>
    <p>$ 19,800  Mensuales</p>
    <hr>
  <!-- Contact -->
