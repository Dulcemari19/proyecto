...
<body>
  ...
  <div class="jumbotron">
    ...
    <center><b><strong><h2 class="w3-text-black">Casa Australia</h2></strong></b></center>
    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
      ...
      <div class="carousel-inner">
        <div class="carousel-item active">
          <img class="d-block w-100" src="img/Chiapas/Casa 1/1.jpg" alt="First slide">
    </div>
    </div>
    ...
    <h4><strong>Detalles</strong></h4>
                  <div class="w3-row w3-large">
                    <div class="w3-col s6">
                      ...
                      <p><i class="fa fa-fw fa-compress"></i> Construidos (m²) 115.13</p>
                      <p><i class="fa fa-fw fa-arrows-alt"></i> Terreno (m²) 200</p>
                    </div>
                 </div>
    <hr>
...
<body>
    ...
    readfile('./menu.html');
    ?>
    <a href="chiapasc.php" class="btn btn-light btn-sm float-right"><i class="fa fa-reply"></i> regresar</a>
    <img src="img/sdihouse.png"width="250" alt="img_conference" class="rounded float-left mr-4"></td><div class="jumbotron text-center">
     <h1>SDI House</h1>
      <p>¿Por cuánto tiempo me quedo con una propiedad? Mi preferencia: para siempre</p> 
    </div>
  ...
  <div class="jumbotron">
    <h1>Campeche</h1>
    <body class="w3-content w3-border-left w3-border-right" ></body>
    <center><b><strong><h2 class="w3-text-black">Recidencia Elena</h2></strong></b></center>
    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
      <ol class="carousel-indicators">
        <li data-target="" data-slide-to="0" class="active"></li>
        <li data-target="" data-slide-to="1"></li>
      ...
      <div class="carousel-inner">
        <div class="carousel-item active">
          <img class="d-block w-100" src="img/Chiapas/Casa 1/1.webp" alt="First slide">
    </div>
    </div>
      <h4><strong>Servicios</strong></h4>
              <div class="w3-row w3-large">
    ...
    <h4><strong>Detalles</strong></h4>
                  <div class="w3-row w3-large">
                    <div class="w3-col s6">
                      <p><i class="fa fa-fw fa-bed"></i> 3 Recámaras</p>
                      <p><i class="fa fa-fw fa-door-open"></i> 5 Habitaciones(en total)</p>
                      <p><i class="fa fa-fw fa-toilet"></i> 2 medio baños</p>
                      <p><i class="fa fa-fw fa-warehouse"></i> Almacen </p>
                      <p><i class="fa fa-fw fa-user-cog"></i> Construido (año) 2018</p>
                      <p><i class="fa fa-fw fa-compress"></i> Construidos (m²) 115.13</p>
                      <p><i class="fa fa-fw fa-arrows-alt"></i> Terreno (m²) 200</p>
    ...
    <h4><strong>Descripción</strong></h4>
    <p> condominio horizontal, ubicado en una de las zonas con mayor 
        plusvalía en el estado,2 1/2 baños, sala, cocina, comedor, espacio
         para dos automóviles y este modelo se adecua a cada estilo d vida.</p>
    <hr>
    <h4><strong>Calcula tu Hipoteca</strong></h4>
    <p>$ 5,500,000  Condominio en Venta</p>
    <hr>
  <!-- Contact -->
