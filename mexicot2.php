...
<body>
    ...
    readfile('./menu.html');
    ?>
    <a href="mexicot.php" class="btn btn-light btn-sm float-right"><i class="fa fa-reply"></i> regresar</a>
    ...
    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
      ...
      <div class="carousel-inner">
        <div class="carousel-item active">
          <img class="d-block w-100" src="img/Terrenos/Estado de México/Terreno 2/1.webp"alt="First slide">
        </div>
    </div>
    <h4><strong>Detalles</strong></h4>
                  <div class="w3-row w3-large">
                    <div class="w3-col s6">
                      <p><i class="fa fa-fw fa-compress"></i> Terreno (m²) 9749</p>
                    </div>
                 </div>
    <hr>
    
    <h4><strong>Descripción</strong></h4>
    <p>Terreno irregular en renta, total o parcial; ubicado sobre Av.Chapultepec, Estado de Mexico.
       -Superficie Total: 9,749.53 m2
       -Frente sobre Av. Guadalajara 234: 64.76 m
       -Frente sobre calle El Cantar: 87.7 m
       -Fondo: 348.86 m
       -Venta: $ 640.00 pesos por m2.
