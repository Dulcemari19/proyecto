...
<body>
  ...
  <div class="jumbotron">
    ...
    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
      ...
      <div class="carousel-inner">
        <div class="carousel-item active">
          <img class="d-block w-100" src="img/Terrenos/Durango/Terreno 2/1.webp"alt="First slide">
        </div>
    </div>
    ...
    <p>Terreno irregular en renta, total o parcial; ubicado sobre Av. Allende, Durango.
       -Superficie Total: 11,236.53 m2
       -Frente sobre Av. Bulebard 334: 32.76 m
       -Frente sobre calle Francesa: 426.7 m
       -Fondo: 28.41 m
       -Venta: $ 410.00 pesos por m2.
