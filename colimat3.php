...
<body>
  ...
  <div class="jumbotron">
    ...
    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
      ...
      <div class="carousel-inner">
        <div class="carousel-item active">
          <img class="d-block w-100" src="img/Terrenos/Colima/Terreno 3/1.webp" alt="First slide">
        </div>
    </div>
    ...
    <p>Terreno irregular en renta, total o parcial; ubicado sobre Av.San Juan, Colima.
       -Superficie Total: 13,396.53 m2
       -Frente sobre Av.El Llano 559: 22.76 m
       -Frente sobre calle 2 de Abril: 236.7 m
       -Fondo: 451.26 m
