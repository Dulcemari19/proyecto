...
<body>
  ...
  <div class="jumbotron">
    ...
    <center><b><strong><h2 class="w3-text-black">101 Estrellas</h2></strong></b></center>
    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
      ...
      <div class="carousel-inner">
        <div class="carousel-item active">
          <img class="d-block w-100" src="img/p1ver.jpg" alt="First slide">
    </div>
    </div>
    ...
    <h4><strong>Detalles</strong></h4>
                  <div class="w3-row w3-large">
                    <div class="w3-col s6">
                      ...
                      <p><i class="fa fa-fw fa-user-cog"></i> Construido (año) 2012</p>
                      <p><i class="fa fa-fw fa-compress"></i> Construidos (m²) 564 </p>
                      <p><i class="fa fa-fw fa-arrows-alt"></i> Terreno (m²) 549</p>
                    </div>
                 </div>
    <hr>
    
    <h4><strong>Descripción</strong></h4>
    <p>Casa en venta 101 Estrellas.Cuenta con 2 niveles, en la planta de abajo cuenta concuenta  con 1 recamara,
     1 baño, cuenta con 1 cocina, una sala, 1 comedor y un almacen, en la segunda planta que es la de arriba
     cuenta con 1 recamaras y un baño. Por la parte de afuera cuenta con un estacionamiento, y un pequeño
    Patio todo para su gran comodidad.</p>
    <hr>
    <h4><strong>Calcula tu Hipoteca</strong></h4>
    <p>$ 47,190  Condominio en Venta</p>
    <hr>
  <!-- Contact -->
