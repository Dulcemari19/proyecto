...
<body>
  ...
  <div class="jumbotron">
    ...
    <center><b><strong><h2 class="w3-text-black">Recidencia Cumbres</h2></strong></b></center>
    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
      ...
      <div class="carousel-inner">
        <div class="carousel-item active">
          <img class="d-block w-100" src="img/Chihuahua/casa 2/1.webp" alt="First slide">
    </div>
    </div>
    ...
    <p> Hermosa residencia en el estado de chihuahua, 
        con una muy discreta ubicación. 
